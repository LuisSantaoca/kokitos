...
require_once("include/cat_holding_03_empresas_almacenes_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_holding_03_empresas_almacenes" );
