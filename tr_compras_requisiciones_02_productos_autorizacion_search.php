...
require_once("include/tr_compras_requisiciones_02_productos_autorizacion_variables.php");
...
$params['shortTableName'] = 'tr_compras_requisiciones_02_productos_autorizacion';
