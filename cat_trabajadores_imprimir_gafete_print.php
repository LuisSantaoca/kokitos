...
require_once("include/cat_trabajadores_imprimir_gafete_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_trabajadores_imprimir_gafete" );
