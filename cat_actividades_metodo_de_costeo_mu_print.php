...
require_once("include/cat_actividades_metodo_de_costeo_mu_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_actividades_metodo_de_costeo_mu" );
