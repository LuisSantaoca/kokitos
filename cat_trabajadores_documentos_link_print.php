...
require_once("include/cat_trabajadores_documentos_link_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_trabajadores_documentos_link" );
