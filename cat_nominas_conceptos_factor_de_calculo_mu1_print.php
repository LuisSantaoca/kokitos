...
require_once("include/cat_nominas_conceptos_factor_de_calculo_mu1_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_nominas_conceptos_factor_de_calculo_mu" );
