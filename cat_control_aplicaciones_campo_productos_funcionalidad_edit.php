...
require_once("include/cat_control_aplicaciones_campo_productos_funcionalidad_variables.php");
...
$keys = array();
$keys["cat_control_aplicaciones_campo_productos_funcionalidad_id"] = postvalue("editid1");
