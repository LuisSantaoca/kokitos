...
require_once("include/box_cat_control_aplicaciones_recetas_cts_01_nombre_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "box_cat_control_aplicaciones_recetas_cts_01_nombre" );
