...
require_once("include/cat_nominas_asistencias_fechas_uuid_semana_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_nominas_asistencias_fechas_uuid_semana" );
