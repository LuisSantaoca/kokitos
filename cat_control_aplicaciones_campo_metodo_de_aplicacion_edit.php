...
require_once("include/cat_control_aplicaciones_campo_metodo_de_aplicacion_variables.php");
...
$keys = array();
$keys["cat_control_aplicaciones_campo_metodo_de_aplicacion_id"] = postvalue("editid1");
