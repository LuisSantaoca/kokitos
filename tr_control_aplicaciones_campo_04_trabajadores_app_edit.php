...
require_once("include/tr_control_aplicaciones_campo_04_trabajadores_app_variables.php");
...
$keys = array();
$keys["tr_control_aplicaciones_campo_04_trabajadores_app_id"] = postvalue("editid1");
