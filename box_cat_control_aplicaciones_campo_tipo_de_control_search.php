...
require_once("include/box_cat_control_aplicaciones_campo_tipo_de_control_variables.php");
...
$params['shortTableName'] = 'box_cat_control_aplicaciones_campo_tipo_de_control';
