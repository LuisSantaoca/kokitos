...
require_once("include/cat_nominas_dias_semana_mu_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_nominas_dias_semana_mu" );
