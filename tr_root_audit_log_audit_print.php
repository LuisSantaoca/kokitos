...
require_once("include/tr_root_audit_log_audit_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tr_root_audit_log_audit" );
