...
require_once("include/tr_actividades_asistencias_app_por_predio_query_variables.php");
...
$params['shortTableName'] = 'tr_actividades_asistencias_app_por_predio_query';
