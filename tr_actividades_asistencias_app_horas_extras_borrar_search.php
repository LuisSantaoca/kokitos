...
require_once("include/tr_actividades_asistencias_app_horas_extras_borrar_variables.php");
...
$params['shortTableName'] = 'tr_actividades_asistencias_app_horas_extras_borrar';
