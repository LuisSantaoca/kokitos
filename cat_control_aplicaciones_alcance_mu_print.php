...
require_once("include/cat_control_aplicaciones_alcance_mu_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_control_aplicaciones_alcance_mu" );
