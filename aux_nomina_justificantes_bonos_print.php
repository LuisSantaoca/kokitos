...
require_once("include/aux_nomina_justificantes_bonos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "aux_nomina_justificantes_bonos" );
