...
require_once("include/tr_compras_requisiciones_01_orden_de_compra_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tr_compras_requisiciones_01_orden_de_compra" );
