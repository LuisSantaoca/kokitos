...
require_once("include/cat_control_aplicaciones_campo_tipo_de_control_variables.php");
...
$keys = array();
$keys["cat_control_aplicaciones_campo_tipo_de_control_id"] = postvalue("editid1");
