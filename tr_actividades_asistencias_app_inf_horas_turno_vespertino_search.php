...
require_once("include/tr_actividades_asistencias_app_inf_horas_turno_vespertino_variables.php");
...
$params['shortTableName'] = 'tr_actividades_asistencias_app_inf_horas_turno_vespertino';
