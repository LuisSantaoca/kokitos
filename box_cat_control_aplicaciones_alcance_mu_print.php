...
require_once("include/box_cat_control_aplicaciones_alcance_mu_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "box_cat_control_aplicaciones_alcance_mu" );
