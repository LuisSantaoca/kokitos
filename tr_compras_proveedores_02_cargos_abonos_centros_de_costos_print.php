...
require_once("include/tr_compras_proveedores_02_cargos_abonos_centros_de_costos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tr_compras_proveedores_02_cargos_abonos_centros_de_costos" );
