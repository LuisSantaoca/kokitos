...
require_once("include/cat_holding_04_unidades_productivas_mu_lotes_categorias_variables.php");
...
$keys = array();
$keys["cat_holding_04_unidades_productivas_mu_lotes_categorias_id"] = postvalue("editid1");
