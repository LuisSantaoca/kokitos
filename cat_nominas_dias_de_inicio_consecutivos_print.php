...
require_once("include/cat_nominas_dias_de_inicio_consecutivos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_nominas_dias_de_inicio_consecutivos" );
