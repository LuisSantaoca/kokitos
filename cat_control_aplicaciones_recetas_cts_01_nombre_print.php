...
require_once("include/cat_control_aplicaciones_recetas_cts_01_nombre_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_control_aplicaciones_recetas_cts_01_nombre" );
