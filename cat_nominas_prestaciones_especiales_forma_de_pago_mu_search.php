...
require_once("include/cat_nominas_prestaciones_especiales_forma_de_pago_mu_variables.php");
...
$params['shortTableName'] = 'cat_nominas_prestaciones_especiales_forma_de_pago_mu';
