...
require_once("include/cat_produccion_proceso_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_produccion_proceso" );
