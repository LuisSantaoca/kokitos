...
require_once("include/cat_holding_03_empresas_unidades_productivas_categorias1_variables.php");
...
$keys = array();
$keys["cat_holding_03_empresas_unidades_productivas_categorias_id"] = postvalue("editid1");
