...
require_once("include/cat_control_aplicaciones_recetas_02_productos_app_variables.php");
...
$keys = array();
$keys["cat_control_aplicaciones_recetas_02_productos_app_id"] = postvalue("editid1");
