Runner.buttonEvents["New_Button2"] = function( pageObj, proxy, pageid ) {
    ...
    sendBtn.onclick = function() {
        ...
        xhr.open("POST", "https://back20.intelagro.net/cosecha_frontal", true);
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4) {
                ...
                if (xhr.status === 200 || xhr.status === 504) {
                    ...
                    codeP.innerText = 'Código: 200';
                    modalContent.appendChild(codeP);

                    var estadoP = document.createElement('p');
                    estadoP.innerText = 'Estado: Datos enviados al servidor';
