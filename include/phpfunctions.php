...
function CustomExpression($value, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="tr_compras_requisiciones_01" && $field=="cat_compras_estatus_mu_id")
	{
		if ($value == 2) {  
$value =$value. ' <img width=25 height=25 src="/images/requis/en_revision.png" alt="" />';  
  $color="white";  
} 
elseif ($value == 6) {  
  $value =$value. ' <img width=25 height=25 src="/images/requis/en_autorizacion.png" alt="" />'; 
  $color="white";  
}  
elseif ($value == 3) {  
  $value =$value. ' <img width=25 height=25 src="/images/requis/aprobado.png" alt="" />'; 
  $color="white";  
}  
elseif ($value == 4) {  
  $value =$value. ' <img width=25 height=25 src="/images/requis/cerrada.png" alt="" />'; 
  $color="white";  
}  
elseif ($value == 5) {  
  $value =$value. ' <img width=25 height=25 src="/images/requis/en_pago.png" alt="" />'; 
  $color="white";  
}  
...
$value="<span style='color: " . $color . "'>" . $value . "</span>";;
		return $value;
				...
				if($table=="tr_compras_requisiciones_01_orden_de_compra" && $field=="id_estatus")
	{
		if ($value == 2) {  
$value =$value. ' <img width=25 height=25 src="/images/requis/en_revision.png" alt="" />';  
  $color="white";  
...
$value="<span style='color: " . $color . "'>" . $value . "</span>";;
		return $value;
				...
				if($table=="tr_compras_requisiciones_01_autorizacion_user" && $field=="id_estatus")
	{
		if ($value == 2) {  
$value =$value. ' <img width=25 height=25 src="/images/requis/en_revision.png" alt="" />';  
  $color="white";  
...
$value="<span style='color: " . $color . "'>" . $value . "</span>";;
		return $value;
				...
				if($table=="tr_compras_requisiciones_01_estatus" && $field=="cat_compras_estatus_mu_id")
	{
		if ($value == 2) {  
$value =$value. ' <img width=25 height=25 src="/images/requis/en_revision.png" alt="" />';  
  $color="white";  
...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="cat_trabajadores_altas" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_altas" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_trabajadores_altas" && $field=="fecha_de_registro")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_usuarios_licencias" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_usuarios_licencias" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_usuarios_licencias" && $field=="fecha_inicio")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="cat_actividades" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_actividades" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_usuarios" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_usuarios" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_usuarios" && $field=="pass")
	{
		return intelagro;
	}
				if($table=="cat_actividades_categorias" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_actividades_categorias" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_documentos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_documentos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_trabajadores_puestos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_puestos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_trabajadores_puestos" && $field=="fecha_de_registro")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_trabajadores_puestos_areas" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_trabajadores_puestos_areas" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_puestos_categorias" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_puestos_categorias" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_trabajadores_imprimir_gafete" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_actividades_unidades_de_costo" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_actividades_unidades_de_costo" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_01" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_01" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_01" && $field=="cat_compras_estatus_mu_id")
	{
		return 2;
				...
				if($table=="tr_compras_requisiciones_01" && $field=="check_compra_directa")
	{
		return 0;
	}
				if($table=="tr_compras_requisiciones_01" && $field=="cat_compras_documentos_mu_id")
	{
		return 7;
	}
				if($table=="cat_compras_productos_categorias" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_compras_productos_categorias" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_compras_proveedores" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_compras_proveedores" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_compras_proveedores" && $field=="costo_check")
	{
		return 1;
	}
				if($table=="cat_holding_01" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_holding_01" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_holding_02_empresas" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_holding_02_empresas" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_holding_03_empresas_registros_patronales" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_holding_03_empresas_registros_patronales" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_compras_proveedores_categorias" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_compras_proveedores_categorias" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_02_productos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_02_productos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_02_productos" && $field=="fecha_de_autorizacion_requisicion")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_compras_requisiciones_02_productos" && $field=="check_producto_pagado")
	{
		return 0;
	}
				if($table=="cat_compras_documentos_mu" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_compras_documentos_mu" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_compras_estatus_mu" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_compras_productos_presentacion_mu" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_compras_productos_presentacion_mu" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_compras_estatus_mu_box" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_usuarios_box" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_usuarios_box" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_usuarios_box" && $field=="pass")
	{
		return intelagro;
	}
				if($table=="tr_compras_requisiciones_01_autorizacion" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_01_autorizacion" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_01_autorizacion" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_compras_requisiciones_01_autorizacion" && $field=="cat_compras_estatus_mu_id")
	{
		return 2;
	}
				if($table=="tr_compras_requisiciones_02_productos_autorizacion" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_02_productos_autorizacion" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_02_productos_autorizacion" && $field=="fecha_de_autorizacion_requisicion")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_compras_requisiciones_02_productos_autorizacion" && $field=="capturista_que_autoriza")
	{
		return $_SESSION["UserName"];
	}
				if($table=="cat_ventas_productos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_ventas_productos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_holding_03_empresas_departamentos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_holding_03_empresas_departamentos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_compras_almacenes" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_compras_almacenes" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_actividades_categorias_mu" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_ventas_productos_categorias" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_ventas_productos_categorias" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_ventas_productos_sku" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_ventas_productos_sku" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_ventas_productos_presentaciones" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_ventas_productos_presentaciones" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_ventas_productos_manejo" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_ventas_productos_manejo" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_ventas_productos_unidades_de_medida" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_ventas_productos_unidades_de_produccion" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_ventas_productos_unidades_de_produccion" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_ventas_productos_marcas" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_ventas_productos_marcas" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_ventas_productos_almacenes_categorias" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_ventas_productos_almacenes_categorias" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_ventas_clientes" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_ventas_clientes" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_ventas_clientes" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_finanzas_movimientos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_finanzas_movimientos" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_finanzas_movimientos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_finanzas_centros_de_costos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_finanzas_centros_de_costos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_usuarios_02_modulos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_usuarios_02_modulos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_usuarios_modulos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_usuarios_modulos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_ventas_productos_unidades_de_venta" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_ventas_productos_unidades_de_venta" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_ventas_productos_almacenes_box" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_ventas_productos_almacenes_box" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_holding_03_empresas_unidades_productivas" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_holding_03_empresas_unidades_productivas" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_finanzas_bancos_01" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_finanzas_bancos_01" && $field=="fecha_registro")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_finanzas_bancos_01" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_finanzas_bancos_02" && $field=="capturista_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_finanzas_bancos_02" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_finanzas_bancos_02" && $field=="fecha_de_registro")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_finanzas_bancos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_finanzas_bancos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_finanzas_bancos_cuentas" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_finanzas_bancos_cuentas" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_finanzas_bancos_cuentas" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_finanzas_bancos_cuentas" && $field=="cat_finanzas_monedas_mu_id")
	{
		return 1;
	}
				if($table=="cat_holding_03_empresas_unidades_productivas_categorias" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_holding_03_empresas_unidades_productivas_categorias" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_holding_04_unidades_productivas_lotes" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_holding_04_unidades_productivas_lotes" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_holding_04_unidades_productivas_lotes_categorias" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_holding_04_unidades_productivas_lotes_categorias" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_holding_04_unidades_productivas_mu_lotes_categorias" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_holding_04_unidades_productivas_mu_lotes_categorias" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_01_orden_de_compra" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_01_orden_de_compra" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_01_orden_de_compra" && $field=="cat_compras_estatus_mu_id")
	{
		return 3;
	}
				if($table=="tr_compras_requisiciones_01_orden_de_compra" && $field=="fecha_de_orden_de_compra")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="tr_compras_requisiciones_02_productos_orden_de_compra" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_02_productos_orden_de_compra" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_02_productos_orden_de_compra" && $field=="fecha_de_autorizacion_requisicion")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_finanzas_transacciones_box" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_finanzas_transacciones_box" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_finanzas_transacciones_box" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_compras_productos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_compras_productos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_finanzas_socios" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_finanzas_socios" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_compras_productos" && $field=="contenido_neto_compras_productos")
	{
		return 1;
	}
				if($table=="box_cat_compras_productos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_compras_productos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_cat_compras_proveedores" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_compras_proveedores" && $field=="costo_check")
	{
		return 1;
	}
				if($table=="box_cat_compras_proveedores" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_usuarios_box_2" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_usuarios_box_2" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_usuarios_box_2" && $field=="pass")
	{
		return intelagro;
	}
				if($table=="tr_compras_requisiciones_01_autorizacion_user" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_01_autorizacion_user" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_01_autorizacion_user" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_compras_requisiciones_01_autorizacion_user" && $field=="cat_compras_estatus_mu_id")
	{
		return 2;
	}
				if($table=="cat_finanzas_cuentas_de_balance_04" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_finanzas_cuentas_de_balance_01_mu" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_finanzas_cuentas_de_balance_01_mu" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_finanzas_cuentas_de_balance_01_mu" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_finanzas_cuentas_de_balance_02_mu" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_finanzas_cuentas_de_balance_02_mu" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_finanzas_cuentas_de_balance_02_mu" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_finanzas_cuentas_de_balance_03_mu" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_finanzas_cuentas_de_balance_03_mu" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_finanzas_cuentas_de_balance_03_mu" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_control_aplicaciones_campo_boquillas" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_control_aplicaciones_campo_boquillas" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_control_aplicaciones_campo_metodo_de_aplicacion" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_control_aplicaciones_campo_metodo_de_aplicacion" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_control_aplicaciones_campo_tipo_de_control" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_control_aplicaciones_campo_tipo_de_control" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_ventas_clientes" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_cat_ventas_clientes" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_ventas_clientes" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_compras_tipo_de_pago_mu" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_compras_tipo_de_pago_mu" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_finanzas_transacciones_categorias_mu" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_finanzas_transacciones_categorias_mu" && $field=="capturista")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_compras_almacenes_estatus_mu" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_compras_almacenes_estatus_mu" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_02_productos_edit_root" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_02_productos_edit_root" && $field=="fecha_de_autorizacion_requisicion")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_trabajadores_altas_root" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_altas_root" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_trabajadores_altas_root" && $field=="fecha_de_registro")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_compras_almacenes_inventario_02_productos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_almacenes_inventario_02_productos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_01_orden_de_compra_enviada" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_01_orden_de_compra_enviada" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_01_orden_de_compra_enviada" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_compras_requisiciones_01_orden_de_compra_enviada" && $field=="cat_compras_estatus_mu_id")
	{
		return 2;
	}
				if($table=="tr_compras_requisiciones_01_orden_de_compra_enviada" && $field=="cat_compras_proveedores_asignacion_mu_id")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_01_orden_de_compra_pagada" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_01_orden_de_compra_pagada" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_01_orden_de_compra_pagada" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_compras_requisiciones_01_orden_de_compra_pagada" && $field=="cat_compras_estatus_mu_id")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_01_orden_de_compra_pagada" && $field=="cat_compras_proveedores_asignacion_mu_id")
	{
		return 1;
	}
				if($table=="ttr_compras_requisiciones_02_productos_orden_de_compra_pagos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="ttr_compras_requisiciones_02_productos_orden_de_compra_pagos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="ttr_compras_requisiciones_02_productos_orden_de_compra_pagos" && $field=="fecha_de_autorizacion_requisicion")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_finanzas_monedas_mu" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_finanzas_monedas_mu" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_01_edti_root" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_01_edti_root" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_01_edti_root" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_compras_requisiciones_01_edti_root" && $field=="cat_compras_estatus_mu_id")
	{
		return 2;
	}
				if($table=="tr_compras_requisiciones_01_edti_root" && $field=="cat_compras_proveedores_asignacion_mu_id")
	{
		return 1;
	}
				if($table=="cat_actividades_variables_de_ejecucion" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_actividades_variables_de_ejecucion" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_nominas_conceptos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_nominas_conceptos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_nominas_conceptos_clasificacion_mu" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_nominas_conceptos_clasificacion_mu" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_nominas_02_actividades" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_nominas_02_actividades" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_nominas_02_actividades" && $field=="cat_nominas_01_generales_uuid")
	{
		return $_SESSION["cat_nominas_01_generales_uuid"];
	}
				if($table=="cat_nominas_02_actividades" && $field=="cat_actividades_alcance_mu_id")
	{
		return 1;
	}
				if($table=="Bancos detalle" && $field=="capturista_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="Bancos detalle" && $field=="vigente")
	{
		return 1;
	}
				if($table=="Bancos detalle" && $field=="fecha_de_registro")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="box_cat_finanzas_bancos_cuentas" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="box_cat_finanzas_bancos_cuentas" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_finanzas_bancos_cuentas" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_cat_finanzas_bancos_cuentas" && $field=="cat_finanzas_monedas_mu_id")
	{
		return 1;
	}
				if($table=="cat_finanzas_cajas_chicas" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_finanzas_cajas_chicas" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_compras_productos_unidad_de_costo_mu" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_compras_productos_unidad_de_costo_mu" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_finanzas_bancos_02_query_dolares" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_finanzas_bancos_02_query_dolares" && $field=="fecha_registro")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_finanzas_bancos_02_query_dolares" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_control_aplicaciones_campo_productos_funcionalidad" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_control_aplicaciones_campo_productos_funcionalidad" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_control_plagas_y_enfermedades" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_control_plagas_y_enfermedades_categorias" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_control_plagas_y_enfermedades_categorias" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_control_de_plagas_app" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_control_de_plagas_app" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_control_de_plagas_app" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_produccion_temporadas" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_produccion_temporadas" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_control_aplicaciones_recetas_02_productos_app" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_control_aplicaciones_recetas_02_productos_app" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_control_aplicaciones_campo_02_up_productos_app" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_control_aplicaciones_campo_02_up_productos_app" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_control_aplicaciones_campo_03_lotes_app" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_control_aplicaciones_campo_03_lotes_app" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_control_aplicaciones_campo_03_lotes_app" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_control_aplicaciones_campo_04_trabajadores_app" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_control_aplicaciones_campo_04_trabajadores_app" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_control_aplicaciones_campo_04_trabajadores_app" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_almacenes_02_recibo_productos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_almacenes_02_recibo_productos" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="tr_compras_almacenes_02_recibo_productos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_orden_de_compra_pagos_03_abonos_productos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_orden_de_compra_pagos_03_abonos_productos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_orden_de_compra_pagos_03_abonos_productos" && $field=="fecha_de_autorizacion_requisicion")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_nominas_incidencias_mu" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_nominas_incidencias_mu" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_finanzas_aportaciones_socios_01" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_finanzas_aportaciones_socios_01" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_finanzas_aportaciones_socios_01" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_menu_sugerencias" && $field=="fecha")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_menu_sugerencias" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_menu_sugerencias" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_actividades_asistencias_app" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_actividades_asistencias_app" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_nominas_01_generales" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_nominas_01_generales" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_nominas_01_generales" && $field=="cat_nominas_01_generales_uuid")
	{
		return $_SESSION['cat_nominas_01_generales_uuid'];
	}
				if($table=="cat_nominas_01_generales" && $field=="horas_semana_laboral")
	{
		return 48;
	}
				if($table=="cat_actividades_especificas" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_actividades_especificas" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_actividades_especificas" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_cat_actividades_especificas" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_nominas_variables_mu" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_nominas_variables_mu" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_nominas_prestaciones_especiales" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_nominas_prestaciones_especiales" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_actividades_turnos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_actividades_turnos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_nominas_prestamos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_nominas_prestamos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_nominas_prestaciones_individuales" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_nominas_prestaciones_individuales" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_nominas_incidencias" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_nominas_incidencias" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_actividades_turnos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_cat_actividades_turnos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_actividades_asistencias_app_semana_uuid" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_actividades_asistencias_app_semana_uuid" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_finanzas_movimientos_categoria" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_finanzas_movimientos_categoria" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_finanzas_movimientos_categoria" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_finanzas_movimientos_categoria_sub" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_finanzas_movimientos_categoria_sub" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_finanzas_movimientos_categoria_sub" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_cat_finanzas_movimientos_categoria_sub" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_finanzas_movimientos_categoria_sub" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="box_cat_finanzas_movimientos_categoria_sub" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_cat_nominas_02_actividades" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_cat_nominas_02_actividades" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_nominas_02_actividades" && $field=="cat_actividades_alcance_mu_id")
	{
		return 1;
	}
				if($table=="cat_control_riego_cabezales" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_control_riego_cabezales" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_control_riego_cabezales_pulsos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_control_riego_cabezales_pulsos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_control_de_riego_pulsos_01" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_control_de_riego_pulsos_01" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_control_de_riego_pulsos_01" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_control_riego_cabezales" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_control_riego_cabezales_pulsos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_cat_control_riego_cabezales_pulsos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_finanzas_bancos_02_movimientos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_finanzas_bancos_02_movimientos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_finanzas_bancos_02_movimientos" && $field=="fecha_de_registro")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_actividades_culturales_01" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_actividades_culturales_01" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_actividades_culturales_01" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_actividades_culturales_02" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_actividades_culturales_02" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_actividades_culturales_02" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_control_aplicaciones_03_trabajadores_sectores" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_control_aplicaciones_03_trabajadores_sectores" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_control_aplicaciones_03_trabajadores_sectores" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_unidad_de_medida_compras" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_unidad_de_medida_compras" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_control_aplicaciones_campo_tipo_de_control" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_cat_control_aplicaciones_campo_tipo_de_control" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_control_aplicaciones_contenedores_mezcladores_mu" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_control_aplicaciones_contenedores_mezcladores_mu" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_compras_productos_precios" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_compras_productos_precios" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_compras_productos_precios" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos" && $field=="fecha_de_compra")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos" && $field=="cat_compras_cargo_abono_mu_id")
	{
		return 1;
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos_pagos" && $field=="fecha_de_pago")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos_pagos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos_pagos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos_pagos" && $field=="cat_compras_cargo_abono_mu_id")
	{
		return 2;
	}
				if($table=="tr_compras_proveedores_01_update_proveedor_detalle" && $field=="cat_compras_cargo_abono_mu_id")
	{
		return 1;
	}
				if($table=="tr_finanzas_bancos_actualizar" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_finanzas_bancos_actualizar" && $field=="fecha_registro")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_finanzas_bancos_actualizar" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_finanzas_tipo_de_cambio" && $field=="fecha")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="tr_finanzas_tipo_de_cambio" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_proveedores_02_cargos_abonos_centros_de_costos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_proveedores_02_cargos_abonos_centros_de_costos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_proveedores_02_cargos_abonos_movimientos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos_update" && $field=="fecha_de_compra")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos_update" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos_update" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos_update" && $field=="cat_compras_cargo_abono_mu_id")
	{
		return 1;
	}
				if($table=="tr_actividades_planeacion_app" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_actividades_planeacion_app" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_actividades_planeacion_app_02" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_actividades_planeacion_app_02" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_actividades_planeacion_tareas_app" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_actividades_planeacion_tareas_app" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_2" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_2" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_02_productos_compras" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_02_productos_compras" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_02_productos_compras" && $field=="fecha_de_autorizacion_requisicion")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_compras_requisiciones_02_productos_compras" && $field=="check_producto_pagado")
	{
		return 0;
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos_pagos_revisar" && $field=="fecha_de_pago")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos_pagos_revisar" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos_pagos_revisar" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_proveedores_01_cargos_abonos_pagos_revisar" && $field=="cat_compras_cargo_abono_mu_id")
	{
		return 2;
	}
				if($table=="tr_compras_facturas_sat_01" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_01_estatus" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_01_estatus" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_01_estatus" && $field=="check_compra_directa")
	{
		return 0;
	}
				if($table=="tr_compras_requisiciones_01_estatus" && $field=="cat_compras_documentos_mu_id")
	{
		return 7;
	}
				if($table=="tr_compras_requisiciones_02_productos_estatus" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_02_productos_estatus" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_requisiciones_02_productos_estatus" && $field=="fecha_de_autorizacion_requisicion")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_compras_requisiciones_02_productos_estatus" && $field=="check_producto_pagado")
	{
		return 0;
	}
				if($table=="cat_finanzas_cuentas_de_balance_5" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_tr_finanzas_bancos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_tr_finanzas_bancos" && $field=="fecha_registro")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="box_tr_finanzas_bancos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_nominas_conceptos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_cat_nominas_conceptos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_actividades_asistencias_app_horas_extras" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_nominas_01_generales_llaves_st" && $field=="cat_nominas_01_generales_uuid")
	{
		return $_SESSION['cat_nominas_01_generales_uuid'];
	}
				if($table=="cat_trabajadores_tipo_de_pago" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_tipo_de_pago" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_actividades_cosecha" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_actividades_cosecha" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_actividades_cosecha" && $field=="identificador_dispositivo")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_produccion_cultivos_01_productos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_produccion_cultivos_01_productos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_actividades_cosecha_consecutivo" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_tabulador" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_trabajadores_tabulador" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_holding_03_empresas_up_group_predios" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_holding_03_empresas_up_group_predios" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_reingresos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_trabajadores_reingresos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_nominas_02_trabajadores" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_nominas_02_trabajadores" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_nominas_01_generales" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_cat_nominas_01_generales" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_nominas_01_generales" && $field=="cat_nominas_01_generales_uuid")
	{
		return $_SESSION['cat_nominas_01_generales_uuid'];
	}
				if($table=="box_cat_nominas_01_generales" && $field=="horas_semana_laboral")
	{
		return 48;
	}
				if($table=="cat_trabajadores_puestos_historico" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_puestos_historico" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_produccion_variedades" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_produccion_variedades" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_actividades_cosecha_query" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_actividades_asistencias_app_por_predio_query" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_altas1" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_altas1" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_trabajadores_altas1" && $field=="fecha_de_registro")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="cat_trabajadores_puestos_historico_query" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_actividades_cosecha1borrar" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_almacenes_01_recibo_lpn" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_almacenes_01_recibo_lpn" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_compras_almacenes_01_recibo_lpn" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_almacenes_01_salida_lpn" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_compras_almacenes_01_salida_lpn" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_compras_almacenes_01_salida_lpn" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_almacenes_02_salida_productos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_almacenes_02_salida_productos" && $field=="fecha_de_captura")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="tr_compras_almacenes_02_salida_productos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_puestos_historico1borrar" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_puestos_historico1borrar" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_almacenes_01_salida_lpn1borrar" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_compras_almacenes_02_salida_productos1borrar" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_holding_04a_unidades_productivas_lotes_historico" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_actividades_asistencias_app_horas_extras_borrar" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_ventas_productos_variedades" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_ventas_productos_variedades" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_compras_productos1" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_compras_productos1" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_ventas_almacenes_01_up_salidas_lpn" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_ventas_almacenes_01_up_salidas_lpn" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_ventas_almacenes_02_up_salidas_productos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_ventas_almacenes_02_up_salidas_productos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="box_cat_ventas_productos_variedades" && $field=="vigente")
	{
		return 1;
	}
				if($table=="box_cat_ventas_productos_variedades" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_actividades_cosecha_salidas_02" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_actividades_cosecha_salidas_02" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_trabajadores_altas2" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_actividades_cosecha_salidas_01 quey glori" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_actividades_cosecha_salidas_01 quey glori" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="tr_actividades_cosecha_salidas_01" && $field=="vigente")
	{
		return 1;
	}
				if($table=="tr_actividades_cosecha_salidas_01" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="aux_puestos_horarios" && $field=="vigente")
	{
		return 1;
	}
				if($table=="aux_horarios" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_nominas_feriados" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_nominas_feriados" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="aux_dias_bonos" && $field=="vigente")
	{
		return 1;
	}
				if($table=="aux_dias_bonos" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="aux_incidencias_justificables" && $field=="vigente")
	{
		return 1;
	}
				if($table=="aux_incidencias_justificables" && $field=="justificable")
	{
		return 1;
	}
				if($table=="cat_produccion_proceso" && $field=="vigente")
	{
		return 1;
	}
				if($table=="cat_produccion_proceso" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_ventas_productos_precios" && $field=="capturista")
	{
		return $_SESSION["UserID"];
	}
				if($table=="cat_ventas_productos_precios" && $field=="vigente")
	{
		return 1;
	}
	return "";
...
function GetAutoUpdateValue($field, $ptype, $table="")
{
				...
				if($table=="tr_compras_requisiciones_02_productos" && $field=="fecha_de_autorizacion_requisicion")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
				...
				if($table=="tr_compras_requisiciones_02_productos_autorizacion" && $field=="autorizado_check")
	{
		return 1;
	}
				if($table=="tr_compras_requisiciones_02_productos_autorizacion" && $field=="fecha_de_autorizacion_requisicion")
