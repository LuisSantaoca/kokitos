...
require_once("include/cat_finanzas_centros_de_costos_categorias_mu_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_finanzas_centros_de_costos_categorias_mu" );
