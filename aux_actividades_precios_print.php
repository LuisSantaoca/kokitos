...
require_once("include/aux_actividades_precios_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "aux_actividades_precios" );
