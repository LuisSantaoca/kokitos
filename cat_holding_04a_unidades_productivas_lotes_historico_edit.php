...
require_once("include/cat_holding_04a_unidades_productivas_lotes_historico_variables.php");
...
$keys = array();
$keys["cat_holding_04a_unidades_productivas_lotes_historico_id"] = postvalue("editid1");
