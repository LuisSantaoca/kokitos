...
require_once("include/cat_control_aplicaciones_contenedores_mezcladores_mu_variables.php");
...
$keys = array();
$keys["cat_control_aplicaciones_contenedores_mezcladores_mu_id"] = postvalue("editid1");
