...
require_once("include/tr_control_aplicaciones_03_trabajadores_sectores_variables.php");
...
$keys = array();
$keys["tr_control_aplicaciones_03_trabajadores_sectores_id"] = postvalue("editid1");
