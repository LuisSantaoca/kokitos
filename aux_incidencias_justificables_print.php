...
require_once("include/aux_incidencias_justificables_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "aux_incidencias_justificables" );
