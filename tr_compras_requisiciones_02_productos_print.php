...
require_once("include/tr_compras_requisiciones_02_productos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tr_compras_requisiciones_02_productos" );
