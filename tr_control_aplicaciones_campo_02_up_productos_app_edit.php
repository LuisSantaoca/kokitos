...
require_once("include/tr_control_aplicaciones_campo_02_up_productos_app_variables.php");
...
$keys = array();
$keys["tr_control_aplicaciones_campo_02_up_productos_app_id"] = postvalue("editid1");
