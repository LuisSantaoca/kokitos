...
require_once("include/cat_compras_almacenes_productos_estatus_catalogo_mu_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_compras_almacenes_productos_estatus_catalogo_mu" );
