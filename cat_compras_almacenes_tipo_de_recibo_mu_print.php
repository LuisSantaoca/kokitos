...
require_once("include/cat_compras_almacenes_tipo_de_recibo_mu_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_compras_almacenes_tipo_de_recibo_mu" );
