...
require_once("include/cat_nominas_configuracion_global_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_nominas_configuracion_global" );
