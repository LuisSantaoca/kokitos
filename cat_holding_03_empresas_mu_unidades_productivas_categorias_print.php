...
require_once("include/cat_holding_03_empresas_mu_unidades_productivas_categorias_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_holding_03_empresas_mu_unidades_productivas_categorias" );
