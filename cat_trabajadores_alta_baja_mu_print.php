...
require_once("include/cat_trabajadores_alta_baja_mu_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "cat_trabajadores_alta_baja_mu" );
