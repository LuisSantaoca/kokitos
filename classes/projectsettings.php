	...
	*/
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("cat_usuarios", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "cat_trabajadores_altas" ] = array( "url" => "cat_trabajadores_altas", "type" => 0 );
	$projectEntitiesReverse[ "cat_trabajadores_altas" ] = "cat_trabajadores_altas";
	...
	$projectEntities[ "cat_usuarios_licencias" ] = array( "url" => "cat_usuarios_licencias", "type" => 0 );
	$projectEntitiesReverse[ "cat_usuarios_licencias" ] = "cat_usuarios_licencias";
	$projectEntities[ "cat_actividades" ] = array( "url" => "cat_actividades", "type" => 0 );
	$projectEntitiesReverse[ "cat_actividades" ] = "cat_actividades";
	$projectEntities[ "cat_usuarios" ] = array( "url" => "cat_usuarios", "type" => 0 );
	$projectEntitiesReverse[ "cat_usuarios" ] = "cat_usuarios";
	$projectEntities[ "con_licencias_filtro" ] = array( "url" => "con_licencias_filtro", "type" => 1 );
	$projectEntitiesReverse[ "con_licencias_filtro" ] = "con_licencias_filtro";
	$projectEntities[ "cat_actividades_categorias" ] = array( "url" => "cat_actividades_categorias1", "type" => 0 );
	$projectEntitiesReverse[ "cat_actividades_categorias1" ] = "cat_actividades_categorias";
	$projectEntities[ "cat_trabajadores_documentos" ] = array( "url" => "cat_trabajadores_documentos", "type" => 0 );
	$projectEntitiesReverse[ "cat_trabajadores_documentos" ] = "cat_trabajadores_documentos";
	$projectEntities[ "cat_trabajadores_puestos" ] = array( "url" => "cat_trabajadores_puestos", "type" => 0 );
	$projectEntitiesReverse[ "cat_trabajadores_puestos" ] = "cat_trabajadores_puestos";
	$projectEntities[ "cat_trabajadores_puestos_areas" ] = array( "url" => "cat_trabajadores_puestos_areas", "type" => 0 );
	$projectEntitiesReverse[ "cat_trabajadores_puestos_areas" ] = "cat_trabajadores_puestos_areas";
	$projectEntities[ "cat_trabajadores_puestos_categorias" ] = array( "url" => "cat_trabajadores_puestos_categorias", "type" => 0 );
	$projectEntitiesReverse[ "cat_trabajadores_puestos_categorias" ] = "cat_trabajadores_puestos_categorias";
	$projectEntities[ "cat_trabajadores_imprimir_gafete" ] = array( "url" => "cat_trabajadores_imprimir_gafete", "type" => 1 );
	$projectEntitiesReverse[ "cat_trabajadores_imprimir_gafete" ] = "cat_trabajadores_imprimir_gafete";
	$projectEntities[ "box_cat_trabajadores" ] = array( "url" => "box_cat_trabajadores", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_trabajadores" ] = "box_cat_trabajadores";
	$projectEntities[ "cat_actividades_unidades_de_costo" ] = array( "url" => "cat_actividades_unidades_de_costo", "type" => 0 );
	$projectEntitiesReverse[ "cat_actividades_unidades_de_costo" ] = "cat_actividades_unidades_de_costo";
	$projectEntities[ "cat_trabajadores_documentos_link" ] = array( "url" => "cat_trabajadores_documentos_link", "type" => 0 );
	$projectEntitiesReverse[ "cat_trabajadores_documentos_link" ] = "cat_trabajadores_documentos_link";
	$projectEntities[ "tr_compras_requisiciones_01" ] = array( "url" => "tr_compras_requisiciones_01", "type" => 0 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_01" ] = "tr_compras_requisiciones_01";
	$projectEntities[ "cat_compras_productos_categorias" ] = array( "url" => "cat_compras_productos_categorias", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_productos_categorias" ] = "cat_compras_productos_categorias";
	$projectEntities[ "cat_compras_proveedores" ] = array( "url" => "cat_compras_proveedores", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_proveedores" ] = "cat_compras_proveedores";
	$projectEntities[ "cat_holding_01" ] = array( "url" => "cat_holding_01", "type" => 0 );
	$projectEntitiesReverse[ "cat_holding_01" ] = "cat_holding_01";
	$projectEntities[ "cat_holding_02_empresas" ] = array( "url" => "cat_holding_02_empresas", "type" => 0 );
	$projectEntitiesReverse[ "cat_holding_02_empresas" ] = "cat_holding_02_empresas";
	$projectEntities[ "cat_holding_03_empresas_registros_patronales" ] = array( "url" => "cat_holding_03_empresas_registros_patronales", "type" => 0 );
	$projectEntitiesReverse[ "cat_holding_03_empresas_registros_patronales" ] = "cat_holding_03_empresas_registros_patronales";
	$projectEntities[ "cat_compras_proveedores_categorias" ] = array( "url" => "cat_compras_proveedores_categorias", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_proveedores_categorias" ] = "cat_compras_proveedores_categorias";
	$projectEntities[ "tr_compras_requisiciones_02_productos" ] = array( "url" => "tr_compras_requisiciones_02_productos", "type" => 0 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_02_productos" ] = "tr_compras_requisiciones_02_productos";
	$projectEntities[ "cat_compras_documentos_mu" ] = array( "url" => "cat_compras_documentos_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_documentos_mu" ] = "cat_compras_documentos_mu";
	$projectEntities[ "cat_compras_estatus_mu" ] = array( "url" => "cat_compras_estatus_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_estatus_mu" ] = "cat_compras_estatus_mu";
	$projectEntities[ "tr_root_audit_editing_locking" ] = array( "url" => "tr_root_audit_editing_locking", "type" => 0 );
	$projectEntitiesReverse[ "tr_root_audit_editing_locking" ] = "tr_root_audit_editing_locking";
	$projectEntities[ "tr_root_audit_log_audit" ] = array( "url" => "tr_root_audit_log_audit", "type" => 0 );
	$projectEntitiesReverse[ "tr_root_audit_log_audit" ] = "tr_root_audit_log_audit";
	$projectEntities[ "cat_compras_productos_unidad_de_medida_mu" ] = array( "url" => "cat_compras_productos_unidad_de_medida_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_productos_unidad_de_medida_mu" ] = "cat_compras_productos_unidad_de_medida_mu";
	$projectEntities[ "cat_compras_productos_presentacion_mu" ] = array( "url" => "cat_compras_productos_presentacion_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_productos_presentacion_mu" ] = "cat_compras_productos_presentacion_mu";
	$projectEntities[ "cat_compras_estatus_mu_box" ] = array( "url" => "cat_compras_estatus_mu_box", "type" => 1 );
	$projectEntitiesReverse[ "cat_compras_estatus_mu_box" ] = "cat_compras_estatus_mu_box";
	$projectEntities[ "cat_usuarios_box" ] = array( "url" => "cat_usuarios_box", "type" => 1 );
	$projectEntitiesReverse[ "cat_usuarios_box" ] = "cat_usuarios_box";
	$projectEntities[ "tr_compras_requisiciones_01_autorizacion" ] = array( "url" => "tr_compras_requisiciones_01_autorizacion", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_01_autorizacion" ] = "tr_compras_requisiciones_01_autorizacion";
	$projectEntities[ "tr_compras_requisiciones_02_productos_autorizacion" ] = array( "url" => "tr_compras_requisiciones_02_productos_autorizacion", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_02_productos_autorizacion" ] = "tr_compras_requisiciones_02_productos_autorizacion";
	$projectEntities[ "cat_ventas_productos" ] = array( "url" => "cat_ventas_productos", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_productos" ] = "cat_ventas_productos";
	$projectEntities[ "cat_holding_03_empresas_departamentos" ] = array( "url" => "cat_holding_03_empresas_departamentos", "type" => 0 );
	$projectEntitiesReverse[ "cat_holding_03_empresas_departamentos" ] = "cat_holding_03_empresas_departamentos";
	$projectEntities[ "cat_compras_almacenes" ] = array( "url" => "cat_compras_almacenes", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_almacenes" ] = "cat_compras_almacenes";
	$projectEntities[ "cat_actividades_categorias_mu" ] = array( "url" => "cat_actividades_categorias_mu1", "type" => 0 );
	$projectEntitiesReverse[ "cat_actividades_categorias_mu1" ] = "cat_actividades_categorias_mu";
	$projectEntities[ "cat_ventas_productos_almacenes" ] = array( "url" => "cat_ventas_productos_almacenes1", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_productos_almacenes1" ] = "cat_ventas_productos_almacenes";
	$projectEntities[ "cat_ventas_productos_categorias" ] = array( "url" => "cat_ventas_productos_categorias", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_productos_categorias" ] = "cat_ventas_productos_categorias";
	$projectEntities[ "cat_ventas_productos_sku" ] = array( "url" => "cat_ventas_productos_sku", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_productos_sku" ] = "cat_ventas_productos_sku";
	$projectEntities[ "cat_ventas_productos_presentaciones" ] = array( "url" => "cat_ventas_productos_presentaciones", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_productos_presentaciones" ] = "cat_ventas_productos_presentaciones";
	$projectEntities[ "cat_ventas_productos_manejo" ] = array( "url" => "cat_ventas_productos_manejo", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_productos_manejo" ] = "cat_ventas_productos_manejo";
	$projectEntities[ "cat_ventas_productos_unidades_de_medida" ] = array( "url" => "cat_ventas_productos_unidades_de_medida", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_productos_unidades_de_medida" ] = "cat_ventas_productos_unidades_de_medida";
	$projectEntities[ "cat_ventas_productos_unidades_de_produccion" ] = array( "url" => "cat_ventas_productos_unidades_de_produccion", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_productos_unidades_de_produccion" ] = "cat_ventas_productos_unidades_de_produccion";
	$projectEntities[ "cat_ventas_productos_marcas" ] = array( "url" => "cat_ventas_productos_marcas", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_productos_marcas" ] = "cat_ventas_productos_marcas";
	$projectEntities[ "cat_ventas_productos_almacenes_categorias" ] = array( "url" => "cat_ventas_productos_almacenes_categorias1", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_productos_almacenes_categorias1" ] = "cat_ventas_productos_almacenes_categorias";
	$projectEntities[ "cat_ventas_clientes" ] = array( "url" => "cat_ventas_clientes", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_clientes" ] = "cat_ventas_clientes";
	$projectEntities[ "cat_finanzas_movimientos" ] = array( "url" => "cat_finanzas_movimientos1", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_movimientos1" ] = "cat_finanzas_movimientos";
	$projectEntities[ "cat_finanzas_centros_de_costos" ] = array( "url" => "cat_finanzas_centros_de_costos", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_centros_de_costos" ] = "cat_finanzas_centros_de_costos";
	$projectEntities[ "cat_trabajadores_box_root" ] = array( "url" => "cat_trabajadores_box_root", "type" => 1 );
	$projectEntitiesReverse[ "cat_trabajadores_box_root" ] = "cat_trabajadores_box_root";
	$projectEntities[ "cat_actividades_box_root" ] = array( "url" => "cat_actividades_box_root", "type" => 1 );
	$projectEntitiesReverse[ "cat_actividades_box_root" ] = "cat_actividades_box_root";
	$projectEntities[ "cat_usuarios_02_modulos" ] = array( "url" => "cat_usuarios_02_modulos", "type" => 0 );
	$projectEntitiesReverse[ "cat_usuarios_02_modulos" ] = "cat_usuarios_02_modulos";
	$projectEntities[ "cat_usuarios_modulos" ] = array( "url" => "cat_usuarios_modulos", "type" => 0 );
	$projectEntitiesReverse[ "cat_usuarios_modulos" ] = "cat_usuarios_modulos";
	$projectEntities[ "cat_ventas_productos_unidades_de_venta" ] = array( "url" => "cat_ventas_productos_unidades_de_venta", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_productos_unidades_de_venta" ] = "cat_ventas_productos_unidades_de_venta";
	$projectEntities[ "cat_ventas_productos_almacenes_box" ] = array( "url" => "cat_ventas_productos_almacenes_box", "type" => 1 );
	$projectEntitiesReverse[ "cat_ventas_productos_almacenes_box" ] = "cat_ventas_productos_almacenes_box";
	$projectEntities[ "cat_ventas_productos_sku_box" ] = array( "url" => "cat_ventas_productos_sku_box", "type" => 1 );
	$projectEntitiesReverse[ "cat_ventas_productos_sku_box" ] = "cat_ventas_productos_sku_box";
	$projectEntities[ "cat_holding_03_empresas_almacenes" ] = array( "url" => "cat_holding_03_empresas_almacenes", "type" => 0 );
	$projectEntitiesReverse[ "cat_holding_03_empresas_almacenes" ] = "cat_holding_03_empresas_almacenes";
	$projectEntities[ "cat_holding_03_empresas_unidades_productivas" ] = array( "url" => "cat_holding_03_empresas_unidades_productivas", "type" => 0 );
	$projectEntitiesReverse[ "cat_holding_03_empresas_unidades_productivas" ] = "cat_holding_03_empresas_unidades_productivas";
	$projectEntities[ "tr_finanzas_bancos_01" ] = array( "url" => "tr_finanzas_bancos_01", "type" => 0 );
	$projectEntitiesReverse[ "tr_finanzas_bancos_01" ] = "tr_finanzas_bancos_01";
	$projectEntities[ "tr_finanzas_bancos_02" ] = array( "url" => "tr_finanzas_bancos_02", "type" => 0 );
	$projectEntitiesReverse[ "tr_finanzas_bancos_02" ] = "tr_finanzas_bancos_02";
	$projectEntities[ "cat_finanzas_bancos" ] = array( "url" => "cat_finanzas_bancos", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_bancos" ] = "cat_finanzas_bancos";
	$projectEntities[ "cat_finanzas_bancos_cuentas" ] = array( "url" => "cat_finanzas_bancos_cuentas", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_bancos_cuentas" ] = "cat_finanzas_bancos_cuentas";
	$projectEntities[ "cat_finanzas_bancos_cuentas_box" ] = array( "url" => "cat_finanzas_bancos_cuentas_box", "type" => 1 );
	$projectEntitiesReverse[ "cat_finanzas_bancos_cuentas_box" ] = "cat_finanzas_bancos_cuentas_box";
	$projectEntities[ "cat_holding_03_empresas_unidades_productivas_categorias" ] = array( "url" => "cat_holding_03_empresas_unidades_productivas_categorias1", "type" => 0 );
	$projectEntitiesReverse[ "cat_holding_03_empresas_unidades_productivas_categorias1" ] = "cat_holding_03_empresas_unidades_productivas_categorias";
	$projectEntities[ "cat_holding_03_empresas_mu_unidades_productivas_categorias" ] = array( "url" => "cat_holding_03_empresas_mu_unidades_productivas_categorias", "type" => 0 );
	$projectEntitiesReverse[ "cat_holding_03_empresas_mu_unidades_productivas_categorias" ] = "cat_holding_03_empresas_mu_unidades_productivas_categorias";
	$projectEntities[ "cat_holding_04_unidades_productivas_lotes" ] = array( "url" => "cat_holding_04_unidades_productivas_lotes", "type" => 0 );
	$projectEntitiesReverse[ "cat_holding_04_unidades_productivas_lotes" ] = "cat_holding_04_unidades_productivas_lotes";
	$projectEntities[ "admin_users" ] = array( "url" => "admin_users", "type" => 1 );
	$projectEntitiesReverse[ "admin_users" ] = "admin_users";
	$projectEntities[ "cat_holding_04_unidades_productivas_lotes_categorias" ] = array( "url" => "cat_holding_04_unidades_productivas_lotes_categorias", "type" => 0 );
	$projectEntitiesReverse[ "cat_holding_04_unidades_productivas_lotes_categorias" ] = "cat_holding_04_unidades_productivas_lotes_categorias";
	$projectEntities[ "cat_holding_04_unidades_productivas_mu_lotes_categorias" ] = array( "url" => "cat_holding_04_unidades_productivas_mu_lotes_categorias", "type" => 0 );
	$projectEntitiesReverse[ "cat_holding_04_unidades_productivas_mu_lotes_categorias" ] = "cat_holding_04_unidades_productivas_mu_lotes_categorias";
	$projectEntities[ "tr_compras_requisiciones_01_orden_de_compra" ] = array( "url" => "tr_compras_requisiciones_01_orden_de_compra", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_01_orden_de_compra" ] = "tr_compras_requisiciones_01_orden_de_compra";
	$projectEntities[ "tr_compras_requisiciones_02_productos_orden_de_compra" ] = array( "url" => "tr_compras_requisiciones_02_productos_orden_de_compra", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_02_productos_orden_de_compra" ] = "tr_compras_requisiciones_02_productos_orden_de_compra";
	$projectEntities[ "cat_finanzas_transacciones_box" ] = array( "url" => "cat_finanzas_transacciones_box", "type" => 1 );
	$projectEntitiesReverse[ "cat_finanzas_transacciones_box" ] = "cat_finanzas_transacciones_box";
	$projectEntities[ "cat_compras_productos" ] = array( "url" => "cat_compras_productos", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_productos" ] = "cat_compras_productos";
	$projectEntities[ "tr_compras_requisiciones_01_informe_intelagro" ] = array( "url" => "tr_compras_requisiciones_01_informe_intelagro", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_01_informe_intelagro" ] = "tr_compras_requisiciones_01_informe_intelagro";
	$projectEntities[ "cat_finanzas_socios" ] = array( "url" => "cat_finanzas_socios", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_socios" ] = "cat_finanzas_socios";
	$projectEntities[ "box_cat_holding_03_empresas_unidades_productivas" ] = array( "url" => "box_cat_holding_03_empresas_unidades_productivas", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_holding_03_empresas_unidades_productivas" ] = "box_cat_holding_03_empresas_unidades_productivas";
	$projectEntities[ "box_cat_compras_productos" ] = array( "url" => "box_cat_compras_productos", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_compras_productos" ] = "box_cat_compras_productos";
	$projectEntities[ "box_cat_actividades_unidades_de_costo" ] = array( "url" => "box_cat_actividades_unidades_de_costo", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_actividades_unidades_de_costo" ] = "box_cat_actividades_unidades_de_costo";
	$projectEntities[ "cat_ventas_productos_lotes" ] = array( "url" => "cat_ventas_productos_lotes", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_productos_lotes" ] = "cat_ventas_productos_lotes";
	$projectEntities[ "cat_finanzas_centros_de_costos_categorias_mu" ] = array( "url" => "cat_finanzas_centros_de_costos_categorias_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_centros_de_costos_categorias_mu" ] = "cat_finanzas_centros_de_costos_categorias_mu";
	$projectEntities[ "box_tr_compras_requisiciones_tr_compras_almacenes_01" ] = array( "url" => "box_tr_compras_requisiciones_tr_compras_almacenes_01", "type" => 1 );
	$projectEntitiesReverse[ "box_tr_compras_requisiciones_tr_compras_almacenes_01" ] = "box_tr_compras_requisiciones_tr_compras_almacenes_01";
	$projectEntities[ "box_cat_compras_almacenes" ] = array( "url" => "box_cat_compras_almacenes", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_compras_almacenes" ] = "box_cat_compras_almacenes";
	$projectEntities[ "box_cat_compras_proveedores" ] = array( "url" => "box_cat_compras_proveedores", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_compras_proveedores" ] = "box_cat_compras_proveedores";
	$projectEntities[ "box_cat_compras_documentos_mu" ] = array( "url" => "box_cat_compras_documentos_mu", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_compras_documentos_mu" ] = "box_cat_compras_documentos_mu";
	$projectEntities[ "cat_usuarios_box_2" ] = array( "url" => "cat_usuarios_box_2", "type" => 1 );
	$projectEntitiesReverse[ "cat_usuarios_box_2" ] = "cat_usuarios_box_2";
	$projectEntities[ "tr_compras_requisiciones_01_autorizacion_user" ] = array( "url" => "tr_compras_requisiciones_01_autorizacion_user", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_01_autorizacion_user" ] = "tr_compras_requisiciones_01_autorizacion_user";
	$projectEntities[ "cat_finanzas_cuentas_de_balance_04" ] = array( "url" => "cat_finanzas_cuentas_de_balance_04", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_cuentas_de_balance_04" ] = "cat_finanzas_cuentas_de_balance_04";
	$projectEntities[ "box_cat_finanzas_cuentas_de_balance_04" ] = array( "url" => "box_cat_finanzas_cuentas_de_balance_04", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_finanzas_cuentas_de_balance_04" ] = "box_cat_finanzas_cuentas_de_balance_04";
	$projectEntities[ "cat_finanzas_cuentas_de_balance_01_mu" ] = array( "url" => "cat_finanzas_cuentas_de_balance_01_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_cuentas_de_balance_01_mu" ] = "cat_finanzas_cuentas_de_balance_01_mu";
	$projectEntities[ "cat_finanzas_cuentas_de_balance_02_mu" ] = array( "url" => "cat_finanzas_cuentas_de_balance_02_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_cuentas_de_balance_02_mu" ] = "cat_finanzas_cuentas_de_balance_02_mu";
	$projectEntities[ "cat_finanzas_cuentas_de_balance_03_mu" ] = array( "url" => "cat_finanzas_cuentas_de_balance_03_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_cuentas_de_balance_03_mu" ] = "cat_finanzas_cuentas_de_balance_03_mu";
	$projectEntities[ "cat_actividades_turnos_mu" ] = array( "url" => "cat_actividades_turnos_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_actividades_turnos_mu" ] = "cat_actividades_turnos_mu";
	$projectEntities[ "box_cat_holding_04_unidades_productivas_lotes" ] = array( "url" => "box_cat_holding_04_unidades_productivas_lotes", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_holding_04_unidades_productivas_lotes" ] = "box_cat_holding_04_unidades_productivas_lotes";
	$projectEntities[ "box_cat_actividades" ] = array( "url" => "box_cat_actividades", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_actividades" ] = "box_cat_actividades";
	$projectEntities[ "cat_control_aplicaciones_campo_boquillas" ] = array( "url" => "cat_control_aplicaciones_campo_boquillas", "type" => 0 );
	$projectEntitiesReverse[ "cat_control_aplicaciones_campo_boquillas" ] = "cat_control_aplicaciones_campo_boquillas";
	$projectEntities[ "cat_control_aplicaciones_campo_metodo_de_aplicacion" ] = array( "url" => "cat_control_aplicaciones_campo_metodo_de_aplicacion", "type" => 0 );
	$projectEntitiesReverse[ "cat_control_aplicaciones_campo_metodo_de_aplicacion" ] = "cat_control_aplicaciones_campo_metodo_de_aplicacion";
	$projectEntities[ "cat_control_aplicaciones_campo_tipo_de_control" ] = array( "url" => "cat_control_aplicaciones_campo_tipo_de_control", "type" => 0 );
	$projectEntitiesReverse[ "cat_control_aplicaciones_campo_tipo_de_control" ] = "cat_control_aplicaciones_campo_tipo_de_control";
	$projectEntities[ "box_cat_ventas_clientes" ] = array( "url" => "box_cat_ventas_clientes", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_ventas_clientes" ] = "box_cat_ventas_clientes";
	$projectEntities[ "box_cat_ventas_productos_sku" ] = array( "url" => "box_cat_ventas_productos_sku", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_ventas_productos_sku" ] = "box_cat_ventas_productos_sku";
	$projectEntities[ "box_tr_compras_facturas_sat_01" ] = array( "url" => "box_tr_compras_facturas_sat_01", "type" => 1 );
	$projectEntitiesReverse[ "box_tr_compras_facturas_sat_01" ] = "box_tr_compras_facturas_sat_01";
	$projectEntities[ "cat_compras_tipo_de_pago_mu" ] = array( "url" => "cat_compras_tipo_de_pago_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_tipo_de_pago_mu" ] = "cat_compras_tipo_de_pago_mu";
	$projectEntities[ "cat_finanzas_transacciones_categorias_mu" ] = array( "url" => "cat_finanzas_transacciones_categorias_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_transacciones_categorias_mu" ] = "cat_finanzas_transacciones_categorias_mu";
	$projectEntities[ "box_cat_finanzas_cuentas_de_balance__traspasos_almacenes" ] = array( "url" => "box_cat_finanzas_cuentas_de_balance__traspasos_almacenes1", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_finanzas_cuentas_de_balance__traspasos_almacenes1" ] = "box_cat_finanzas_cuentas_de_balance__traspasos_almacenes";
	$projectEntities[ "cat_compras_almacenes_estatus_mu" ] = array( "url" => "cat_compras_almacenes_estatus_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_almacenes_estatus_mu" ] = "cat_compras_almacenes_estatus_mu";
	$projectEntities[ "tr_compras_requisiciones_02_productos_edit_root" ] = array( "url" => "tr_compras_requisiciones_02_productos_edit_root", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_02_productos_edit_root" ] = "tr_compras_requisiciones_02_productos_edit_root";
	$projectEntities[ "box_lotes_root" ] = array( "url" => "box_lotes_root", "type" => 1 );
	$projectEntitiesReverse[ "box_lotes_root" ] = "box_lotes_root";
	$projectEntities[ "cat_trabajadores_altas_root" ] = array( "url" => "cat_trabajadores_altas_root", "type" => 1 );
	$projectEntitiesReverse[ "cat_trabajadores_altas_root" ] = "cat_trabajadores_altas_root";
	$projectEntities[ "tr_compras_almacenes_inventario_02_productos" ] = array( "url" => "tr_compras_almacenes_inventario_02_productos", "type" => 0 );
	$projectEntitiesReverse[ "tr_compras_almacenes_inventario_02_productos" ] = "tr_compras_almacenes_inventario_02_productos";
	$projectEntities[ "tr_compras_almacenes_inventario_03" ] = array( "url" => "tr_compras_almacenes_inventario_03", "type" => 0 );
	$projectEntitiesReverse[ "tr_compras_almacenes_inventario_03" ] = "tr_compras_almacenes_inventario_03";
	$projectEntities[ "cat_nominas_dias_semana_mu" ] = array( "url" => "cat_nominas_dias_semana_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_dias_semana_mu" ] = "cat_nominas_dias_semana_mu";
	$projectEntities[ "cat_nominas_periodicidad_mu" ] = array( "url" => "cat_nominas_periodicidad_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_periodicidad_mu" ] = "cat_nominas_periodicidad_mu";
	$projectEntities[ "tr_compras_requisiciones_01_orden_de_compra_enviada" ] = array( "url" => "tr_compras_requisiciones_01_orden_de_compra_enviada", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_01_orden_de_compra_enviada" ] = "tr_compras_requisiciones_01_orden_de_compra_enviada";
	$projectEntities[ "tr_compras_requisiciones_01_orden_de_compra_pagada" ] = array( "url" => "tr_compras_requisiciones_01_orden_de_compra_pagada", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_01_orden_de_compra_pagada" ] = "tr_compras_requisiciones_01_orden_de_compra_pagada";
	$projectEntities[ "ttr_compras_requisiciones_02_productos_orden_de_compra_pagos" ] = array( "url" => "ttr_compras_requisiciones_02_productos_orden_de_compra_pagos", "type" => 1 );
	$projectEntitiesReverse[ "ttr_compras_requisiciones_02_productos_orden_de_compra_pagos" ] = "ttr_compras_requisiciones_02_productos_orden_de_compra_pagos";
	$projectEntities[ "tr_finanzas_movimientos_balance" ] = array( "url" => "tr_finanzas_movimientos_balance1", "type" => 0 );
	$projectEntitiesReverse[ "tr_finanzas_movimientos_balance1" ] = "tr_finanzas_movimientos_balance";
	$projectEntities[ "box_cat_finanzas_cuentas_de_balance_03_mu" ] = array( "url" => "box_cat_finanzas_cuentas_de_balance_03_mu", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_finanzas_cuentas_de_balance_03_mu" ] = "box_cat_finanzas_cuentas_de_balance_03_mu";
	$projectEntities[ "cat_finanzas_movimientos_categorias_naturaleza_mu" ] = array( "url" => "cat_finanzas_movimientos_categorias_naturaleza_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_movimientos_categorias_naturaleza_mu" ] = "cat_finanzas_movimientos_categorias_naturaleza_mu";
	$projectEntities[ "box_cat_finanzas_movimientos" ] = array( "url" => "box_cat_finanzas_movimientos", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_finanzas_movimientos" ] = "box_cat_finanzas_movimientos";
	$projectEntities[ "cat_finanzas_monedas_mu" ] = array( "url" => "cat_finanzas_monedas_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_monedas_mu" ] = "cat_finanzas_monedas_mu";
	$projectEntities[ "tr_compras_requisiciones_01_edti_root" ] = array( "url" => "tr_compras_requisiciones_01_edti_root", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_01_edti_root" ] = "tr_compras_requisiciones_01_edti_root";
	$projectEntities[ "cat_root_tablas_de_catalogos" ] = array( "url" => "cat_root_tablas_de_catalogos", "type" => 0 );
	$projectEntitiesReverse[ "cat_root_tablas_de_catalogos" ] = "cat_root_tablas_de_catalogos";
	$projectEntities[ "cat_actividades_variables_de_ejecucion" ] = array( "url" => "cat_actividades_variables_de_ejecucion1", "type" => 0 );
	$projectEntitiesReverse[ "cat_actividades_variables_de_ejecucion1" ] = "cat_actividades_variables_de_ejecucion";
	$projectEntities[ "cat_nominas_conceptos" ] = array( "url" => "cat_nominas_conceptos1", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_conceptos1" ] = "cat_nominas_conceptos";
	$projectEntities[ "cat_nominas_conceptos_clasificacion_mu" ] = array( "url" => "cat_nominas_conceptos_clasificacion_mu1", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_conceptos_clasificacion_mu1" ] = "cat_nominas_conceptos_clasificacion_mu";
	$projectEntities[ "cat_nominas_02_actividades" ] = array( "url" => "cat_nominas_02_actividades", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_02_actividades" ] = "cat_nominas_02_actividades";
	$projectEntities[ "cat_actividades_alcance_mu" ] = array( "url" => "cat_actividades_alcance_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_actividades_alcance_mu" ] = "cat_actividades_alcance_mu";
	$projectEntities[ "cat_nominas_conceptos_factor_de_calculo_mu" ] = array( "url" => "cat_nominas_conceptos_factor_de_calculo_mu1", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_conceptos_factor_de_calculo_mu1" ] = "cat_nominas_conceptos_factor_de_calculo_mu";
	$projectEntities[ "cat_nominas_intervalos_mu" ] = array( "url" => "cat_nominas_intervalos_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_intervalos_mu" ] = "cat_nominas_intervalos_mu";
	$projectEntities[ "Bancos detalle" ] = array( "url" => "bancos_detalle", "type" => 1 );
	$projectEntitiesReverse[ "bancos_detalle" ] = "Bancos detalle";
	$projectEntities[ "box_cat_finanzas_bancos_cuentas" ] = array( "url" => "box_cat_finanzas_bancos_cuentas", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_finanzas_bancos_cuentas" ] = "box_cat_finanzas_bancos_cuentas";
	$projectEntities[ "box_cat_finanzas_centros_de_costos" ] = array( "url" => "box_cat_finanzas_centros_de_costos", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_finanzas_centros_de_costos" ] = "box_cat_finanzas_centros_de_costos";
	$projectEntities[ "cat_finanzas_cajas_chicas" ] = array( "url" => "cat_finanzas_cajas_chicas", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_cajas_chicas" ] = "cat_finanzas_cajas_chicas";
	$projectEntities[ "box_cat_finanzas_cajas_chicas" ] = array( "url" => "box_cat_finanzas_cajas_chicas", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_finanzas_cajas_chicas" ] = "box_cat_finanzas_cajas_chicas";
	$projectEntities[ "cat_compras_productos_unidad_de_costo_mu" ] = array( "url" => "cat_compras_productos_unidad_de_costo_mu1", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_productos_unidad_de_costo_mu1" ] = "cat_compras_productos_unidad_de_costo_mu";
	$projectEntities[ "tr_finanzas_bancos_02_query_dolares" ] = array( "url" => "tr_finanzas_bancos_02_query_dolares", "type" => 1 );
	$projectEntitiesReverse[ "tr_finanzas_bancos_02_query_dolares" ] = "tr_finanzas_bancos_02_query_dolares";
	$projectEntities[ "zz_script query" ] = array( "url" => "zz_script_query", "type" => 1 );
	$projectEntitiesReverse[ "zz_script_query" ] = "zz_script query";
	$projectEntities[ "cat_control_aplicaciones_campo_productos_funcionalidad" ] = array( "url" => "cat_control_aplicaciones_campo_productos_funcionalidad", "type" => 0 );
	$projectEntitiesReverse[ "cat_control_aplicaciones_campo_productos_funcionalidad" ] = "cat_control_aplicaciones_campo_productos_funcionalidad";
	$projectEntities[ "cat_control_plagas_y_enfermedades" ] = array( "url" => "cat_control_plagas_y_enfermedades", "type" => 0 );
	$projectEntitiesReverse[ "cat_control_plagas_y_enfermedades" ] = "cat_control_plagas_y_enfermedades";
	$projectEntities[ "box_cat_control_plagas_y_enfermedades" ] = array( "url" => "box_cat_control_plagas_y_enfermedades", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_control_plagas_y_enfermedades" ] = "box_cat_control_plagas_y_enfermedades";
	$projectEntities[ "cat_control_plagas_y_enfermedades_categorias" ] = array( "url" => "cat_control_plagas_y_enfermedades_categorias", "type" => 0 );
	$projectEntitiesReverse[ "cat_control_plagas_y_enfermedades_categorias" ] = "cat_control_plagas_y_enfermedades_categorias";
	$projectEntities[ "tr_control_de_plagas_app" ] = array( "url" => "tr_control_de_plagas_app", "type" => 0 );
	$projectEntitiesReverse[ "tr_control_de_plagas_app" ] = "tr_control_de_plagas_app";
	$projectEntities[ "box_cat_compras_productos_app" ] = array( "url" => "box_cat_compras_productos_app", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_compras_productos_app" ] = "box_cat_compras_productos_app";
	$projectEntities[ "cat_compras_almacenes_productos_estatus_catalogo_mu" ] = array( "url" => "cat_compras_almacenes_productos_estatus_catalogo_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_almacenes_productos_estatus_catalogo_mu" ] = "cat_compras_almacenes_productos_estatus_catalogo_mu";
	$projectEntities[ "cat_compras_almacenes_tipo_de_recibo_mu" ] = array( "url" => "cat_compras_almacenes_tipo_de_recibo_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_almacenes_tipo_de_recibo_mu" ] = "cat_compras_almacenes_tipo_de_recibo_mu";
	$projectEntities[ "box_cat_compras_almacenes_tipo_de_recibo_mu" ] = array( "url" => "box_cat_compras_almacenes_tipo_de_recibo_mu", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_compras_almacenes_tipo_de_recibo_mu" ] = "box_cat_compras_almacenes_tipo_de_recibo_mu";
	$projectEntities[ "tr_control_aplicaciones_campo_planeacion_recetas_app" ] = array( "url" => "tr_control_aplicaciones_campo_planeacion_recetas_app", "type" => 0 );
	$projectEntitiesReverse[ "tr_control_aplicaciones_campo_planeacion_recetas_app" ] = "tr_control_aplicaciones_campo_planeacion_recetas_app";
	$projectEntities[ "cat_nominas_configuracion_global" ] = array( "url" => "cat_nominas_configuracion_global", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_configuracion_global" ] = "cat_nominas_configuracion_global";
	$projectEntities[ "cat_produccion_temporadas" ] = array( "url" => "cat_produccion_temporadas", "type" => 0 );
	$projectEntitiesReverse[ "cat_produccion_temporadas" ] = "cat_produccion_temporadas";
	$projectEntities[ "cat_control_aplicaciones_alcance_mu" ] = array( "url" => "cat_control_aplicaciones_alcance_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_control_aplicaciones_alcance_mu" ] = "cat_control_aplicaciones_alcance_mu";
	$projectEntities[ "box_cat_control_aplicaciones_alcance_mu" ] = array( "url" => "box_cat_control_aplicaciones_alcance_mu", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_control_aplicaciones_alcance_mu" ] = "box_cat_control_aplicaciones_alcance_mu";
	$projectEntities[ "cat_control_aplicaciones_recetas_02_productos_app" ] = array( "url" => "cat_control_aplicaciones_recetas_02_productos_app", "type" => 0 );
	$projectEntitiesReverse[ "cat_control_aplicaciones_recetas_02_productos_app" ] = "cat_control_aplicaciones_recetas_02_productos_app";
	$projectEntities[ "cat_control_aplicaciones_recetas_cts_01_nombre" ] = array( "url" => "cat_control_aplicaciones_recetas_cts_01_nombre", "type" => 0 );
	$projectEntitiesReverse[ "cat_control_aplicaciones_recetas_cts_01_nombre" ] = "cat_control_aplicaciones_recetas_cts_01_nombre";
	$projectEntities[ "box_cat_control_aplicaciones_recetas_cts_01_nombre" ] = array( "url" => "box_cat_control_aplicaciones_recetas_cts_01_nombre", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_control_aplicaciones_recetas_cts_01_nombre" ] = "box_cat_control_aplicaciones_recetas_cts_01_nombre";
	$projectEntities[ "tr_control_aplicaciones_campo_02_up_productos_app" ] = array( "url" => "tr_control_aplicaciones_campo_02_up_productos_app", "type" => 0 );
	$projectEntitiesReverse[ "tr_control_aplicaciones_campo_02_up_productos_app" ] = "tr_control_aplicaciones_campo_02_up_productos_app";
	$projectEntities[ "tr_control_aplicaciones_campo_03_lotes_app" ] = array( "url" => "tr_control_aplicaciones_campo_03_lotes_app", "type" => 0 );
	$projectEntitiesReverse[ "tr_control_aplicaciones_campo_03_lotes_app" ] = "tr_control_aplicaciones_campo_03_lotes_app";
	$projectEntities[ "tr_control_aplicaciones_campo_04_trabajadores_app" ] = array( "url" => "tr_control_aplicaciones_campo_04_trabajadores_app", "type" => 0 );
	$projectEntitiesReverse[ "tr_control_aplicaciones_campo_04_trabajadores_app" ] = "tr_control_aplicaciones_campo_04_trabajadores_app";
	$projectEntities[ "tr_compras_almacenes_02_recibo_productos" ] = array( "url" => "tr_compras_almacenes_02_recibo_productos", "type" => 0 );
	$projectEntitiesReverse[ "tr_compras_almacenes_02_recibo_productos" ] = "tr_compras_almacenes_02_recibo_productos";
	$projectEntities[ "cat_control_aplicaciones_recetas_cts_01_nombre_query" ] = array( "url" => "cat_control_aplicaciones_recetas_cts_01_nombre_query", "type" => 1 );
	$projectEntitiesReverse[ "cat_control_aplicaciones_recetas_cts_01_nombre_query" ] = "cat_control_aplicaciones_recetas_cts_01_nombre_query";
	$projectEntities[ "tr_compras_orden_de_compra_pagos_03_abonos_productos" ] = array( "url" => "tr_compras_orden_de_compra_pagos_03_abonos_productos", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_orden_de_compra_pagos_03_abonos_productos" ] = "tr_compras_orden_de_compra_pagos_03_abonos_productos";
	$projectEntities[ "tr_compras_facturas_sat_02_carga_masiva" ] = array( "url" => "tr_compras_facturas_sat_02_carga_masiva", "type" => 0 );
	$projectEntitiesReverse[ "tr_compras_facturas_sat_02_carga_masiva" ] = "tr_compras_facturas_sat_02_carga_masiva";
	$projectEntities[ "cat_nominas_incidencias_mu" ] = array( "url" => "cat_nominas_incidencias_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_incidencias_mu" ] = "cat_nominas_incidencias_mu";
	$projectEntities[ "tr_finanzas_bancos_02_uuid_sat" ] = array( "url" => "tr_finanzas_bancos_02_uuid_sat", "type" => 0 );
	$projectEntitiesReverse[ "tr_finanzas_bancos_02_uuid_sat" ] = "tr_finanzas_bancos_02_uuid_sat";
	$projectEntities[ "tr_finanzas_aportaciones_socios_01" ] = array( "url" => "tr_finanzas_aportaciones_socios_01", "type" => 0 );
	$projectEntitiesReverse[ "tr_finanzas_aportaciones_socios_01" ] = "tr_finanzas_aportaciones_socios_01";
	$projectEntities[ "tr_menu_noticias" ] = array( "url" => "tr_menu_noticias1", "type" => 0 );
	$projectEntitiesReverse[ "tr_menu_noticias1" ] = "tr_menu_noticias";
	$projectEntities[ "tr_menu_sugerencias" ] = array( "url" => "tr_menu_sugerencias1", "type" => 0 );
	$projectEntitiesReverse[ "tr_menu_sugerencias1" ] = "tr_menu_sugerencias";
	$projectEntities[ "tr_actividades_asistencias_app" ] = array( "url" => "tr_actividades_asistencias_app", "type" => 0 );
	$projectEntitiesReverse[ "tr_actividades_asistencias_app" ] = "tr_actividades_asistencias_app";
	$projectEntities[ "cat_nominas_01_generales" ] = array( "url" => "cat_nominas_01_generales", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_01_generales" ] = "cat_nominas_01_generales";
	$projectEntities[ "cat_nominas_03_trabajadoress_costo_bruto_conceptos_edicion_masiva" ] = array( "url" => "cat_nominas_03_trabajadoress_costo_bruto_conceptos_edicion_masiva", "type" => 1 );
	$projectEntitiesReverse[ "cat_nominas_03_trabajadoress_costo_bruto_conceptos_edicion_masiva" ] = "cat_nominas_03_trabajadoress_costo_bruto_conceptos_edicion_masiva";
	$projectEntities[ "cat_actividades_especificas" ] = array( "url" => "cat_actividades_especificas1", "type" => 0 );
	$projectEntitiesReverse[ "cat_actividades_especificas1" ] = "cat_actividades_especificas";
	$projectEntities[ "cat_actividades_metodo_de_costeo_mu" ] = array( "url" => "cat_actividades_metodo_de_costeo_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_actividades_metodo_de_costeo_mu" ] = "cat_actividades_metodo_de_costeo_mu";
	$projectEntities[ "cat_actividades_forma_de_pago_mu" ] = array( "url" => "cat_actividades_forma_de_pago_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_actividades_forma_de_pago_mu" ] = "cat_actividades_forma_de_pago_mu";
	$projectEntities[ "box_cat_actividades_especificas" ] = array( "url" => "box_cat_actividades_especificas", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_actividades_especificas" ] = "box_cat_actividades_especificas";
	$projectEntities[ "cat_nominas_variables_mu" ] = array( "url" => "cat_nominas_variables_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_variables_mu" ] = "cat_nominas_variables_mu";
	$projectEntities[ "cat_nominas_condicionantes_mu" ] = array( "url" => "cat_nominas_condicionantes_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_condicionantes_mu" ] = "cat_nominas_condicionantes_mu";
	$projectEntities[ "cat_root_operadores" ] = array( "url" => "cat_root_operadores", "type" => 0 );
	$projectEntitiesReverse[ "cat_root_operadores" ] = "cat_root_operadores";
	$projectEntities[ "cat_nominas_prestaciones_especiales" ] = array( "url" => "cat_nominas_prestaciones_especiales", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_prestaciones_especiales" ] = "cat_nominas_prestaciones_especiales";
	$projectEntities[ "cat_nominas_prestaciones_especiales_forma_de_pago_mu" ] = array( "url" => "cat_nominas_prestaciones_especiales_forma_de_pago_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_prestaciones_especiales_forma_de_pago_mu" ] = "cat_nominas_prestaciones_especiales_forma_de_pago_mu";
	$projectEntities[ "cat_actividades_turnos" ] = array( "url" => "cat_actividades_turnos", "type" => 0 );
	$projectEntitiesReverse[ "cat_actividades_turnos" ] = "cat_actividades_turnos";
	$projectEntities[ "cat_nominas_uuid_semana" ] = array( "url" => "cat_nominas_uuid_semana", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_uuid_semana" ] = "cat_nominas_uuid_semana";
	$projectEntities[ "cat_nominas_prestamos" ] = array( "url" => "cat_nominas_prestamos", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_prestamos" ] = "cat_nominas_prestamos";
	$projectEntities[ "cat_nominas_prestaciones_individuales" ] = array( "url" => "cat_nominas_prestaciones_individuales", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_prestaciones_individuales" ] = "cat_nominas_prestaciones_individuales";
	$projectEntities[ "cat_nominas_incidencias" ] = array( "url" => "cat_nominas_incidencias", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_incidencias" ] = "cat_nominas_incidencias";
	$projectEntities[ "box_cat_nominas_uuid_semana" ] = array( "url" => "box_cat_nominas_uuid_semana", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_nominas_uuid_semana" ] = "box_cat_nominas_uuid_semana";
	$projectEntities[ "cat_actividades_ingreso_egreso_mu" ] = array( "url" => "cat_actividades_ingreso_egreso_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_actividades_ingreso_egreso_mu" ] = "cat_actividades_ingreso_egreso_mu";
	$projectEntities[ "box_cat_actividades_turnos" ] = array( "url" => "box_cat_actividades_turnos", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_actividades_turnos" ] = "box_cat_actividades_turnos";
	$projectEntities[ "tr_actividades_asistencias_app_semana_uuid" ] = array( "url" => "tr_actividades_asistencias_app_semana_uuid", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_asistencias_app_semana_uuid" ] = "tr_actividades_asistencias_app_semana_uuid";
	$projectEntities[ "cat_nominas_dias_de_inicio_consecutivos" ] = array( "url" => "cat_nominas_dias_de_inicio_consecutivos", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_dias_de_inicio_consecutivos" ] = "cat_nominas_dias_de_inicio_consecutivos";
	$projectEntities[ "cat_nominas_asistencias_fechas" ] = array( "url" => "cat_nominas_asistencias_fechas", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_asistencias_fechas" ] = "cat_nominas_asistencias_fechas";
	$projectEntities[ "cat_nominas_asistencias_fechas_uuid_semana" ] = array( "url" => "cat_nominas_asistencias_fechas_uuid_semana", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_asistencias_fechas_uuid_semana" ] = "cat_nominas_asistencias_fechas_uuid_semana";
	$projectEntities[ "cat_finanzas_movimientos_categoria" ] = array( "url" => "cat_finanzas_movimientos_categoria", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_movimientos_categoria" ] = "cat_finanzas_movimientos_categoria";
	$projectEntities[ "cat_finanzas_movimientos_categoria_sub" ] = array( "url" => "cat_finanzas_movimientos_categoria_sub", "type" => 0 );
	$projectEntitiesReverse[ "cat_finanzas_movimientos_categoria_sub" ] = "cat_finanzas_movimientos_categoria_sub";
	$projectEntities[ "box_cat_finanzas_movimientos_categoria" ] = array( "url" => "box_cat_finanzas_movimientos_categoria", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_finanzas_movimientos_categoria" ] = "box_cat_finanzas_movimientos_categoria";
	$projectEntities[ "box_cat_finanzas_movimientos_categoria_sub" ] = array( "url" => "box_cat_finanzas_movimientos_categoria_sub", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_finanzas_movimientos_categoria_sub" ] = "box_cat_finanzas_movimientos_categoria_sub";
	$projectEntities[ "box_cat_nominas_02_actividades" ] = array( "url" => "box_cat_nominas_02_actividades", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_nominas_02_actividades" ] = "box_cat_nominas_02_actividades";
	$projectEntities[ "cat_control_riego_cabezales" ] = array( "url" => "cat_control_riego_cabezales", "type" => 0 );
	$projectEntitiesReverse[ "cat_control_riego_cabezales" ] = "cat_control_riego_cabezales";
	$projectEntities[ "cat_control_riego_cabezales_pulsos" ] = array( "url" => "cat_control_riego_cabezales_pulsos", "type" => 0 );
	$projectEntitiesReverse[ "cat_control_riego_cabezales_pulsos" ] = "cat_control_riego_cabezales_pulsos";
	$projectEntities[ "tr_control_de_riego_pulsos_01" ] = array( "url" => "tr_control_de_riego_pulsos_01", "type" => 0 );
	$projectEntitiesReverse[ "tr_control_de_riego_pulsos_01" ] = "tr_control_de_riego_pulsos_01";
	$projectEntities[ "tr_control_de_riego_pulsos_02_lotes" ] = array( "url" => "tr_control_de_riego_pulsos_02_lotes", "type" => 0 );
	$projectEntitiesReverse[ "tr_control_de_riego_pulsos_02_lotes" ] = "tr_control_de_riego_pulsos_02_lotes";
	$projectEntities[ "box_cat_control_riego_cabezales" ] = array( "url" => "box_cat_control_riego_cabezales", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_control_riego_cabezales" ] = "box_cat_control_riego_cabezales";
	$projectEntities[ "box_cat_control_riego_cabezales_pulsos" ] = array( "url" => "box_cat_control_riego_cabezales_pulsos", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_control_riego_cabezales_pulsos" ] = "box_cat_control_riego_cabezales_pulsos";
	$projectEntities[ "tr_finanzas_bancos_02_movimientos" ] = array( "url" => "tr_finanzas_bancos_02_movimientos", "type" => 0 );
	$projectEntitiesReverse[ "tr_finanzas_bancos_02_movimientos" ] = "tr_finanzas_bancos_02_movimientos";
	$projectEntities[ "tr_actividades_culturales_01" ] = array( "url" => "tr_actividades_culturales_01", "type" => 0 );
	$projectEntitiesReverse[ "tr_actividades_culturales_01" ] = "tr_actividades_culturales_01";
	$projectEntities[ "tr_actividades_culturales_02" ] = array( "url" => "tr_actividades_culturales_02", "type" => 0 );
	$projectEntitiesReverse[ "tr_actividades_culturales_02" ] = "tr_actividades_culturales_02";
	$projectEntities[ "tr_control_aplicaciones_03_trabajadores_sectores" ] = array( "url" => "tr_control_aplicaciones_03_trabajadores_sectores", "type" => 0 );
	$projectEntitiesReverse[ "tr_control_aplicaciones_03_trabajadores_sectores" ] = "tr_control_aplicaciones_03_trabajadores_sectores";
	$projectEntities[ "box_unidad_de_medida_compras" ] = array( "url" => "box_unidad_de_medida_compras", "type" => 1 );
	$projectEntitiesReverse[ "box_unidad_de_medida_compras" ] = "box_unidad_de_medida_compras";
	$projectEntities[ "box_cat_control_aplicaciones_campo_tipo_de_control" ] = array( "url" => "box_cat_control_aplicaciones_campo_tipo_de_control", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_control_aplicaciones_campo_tipo_de_control" ] = "box_cat_control_aplicaciones_campo_tipo_de_control";
	$projectEntities[ "cat_control_aplicaciones_contenedores_mezcladores_mu" ] = array( "url" => "cat_control_aplicaciones_contenedores_mezcladores_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_control_aplicaciones_contenedores_mezcladores_mu" ] = "cat_control_aplicaciones_contenedores_mezcladores_mu";
	$projectEntities[ "cat_compras_productos_precios" ] = array( "url" => "cat_compras_productos_precios", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_productos_precios" ] = "cat_compras_productos_precios";
	$projectEntities[ "cat_compras_proveedores_sat" ] = array( "url" => "cat_compras_proveedores_sat", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_proveedores_sat" ] = "cat_compras_proveedores_sat";
	$projectEntities[ "tr_compras_proveedores_01_cargos_abonos" ] = array( "url" => "tr_compras_proveedores_01_cargos_abonos", "type" => 0 );
	$projectEntitiesReverse[ "tr_compras_proveedores_01_cargos_abonos" ] = "tr_compras_proveedores_01_cargos_abonos";
	$projectEntities[ "cat_compras_cargo_abono_mu" ] = array( "url" => "cat_compras_cargo_abono_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_cargo_abono_mu" ] = "cat_compras_cargo_abono_mu";
	$projectEntities[ "tr_compras_proveedores_02_saldos" ] = array( "url" => "tr_compras_proveedores_02_saldos", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_proveedores_02_saldos" ] = "tr_compras_proveedores_02_saldos";
	$projectEntities[ "tr_compras_proveedores_01_cargos_abonos_pagos" ] = array( "url" => "tr_compras_proveedores_01_cargos_abonos_pagos", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_proveedores_01_cargos_abonos_pagos" ] = "tr_compras_proveedores_01_cargos_abonos_pagos";
	$projectEntities[ "tr_compras_proveedores_01_update_proveedor_detalle" ] = array( "url" => "tr_compras_proveedores_01_update_proveedor_detalle", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_proveedores_01_update_proveedor_detalle" ] = "tr_compras_proveedores_01_update_proveedor_detalle";
	$projectEntities[ "tr_finanzas_bancos_actualizar" ] = array( "url" => "tr_finanzas_bancos_actualizar", "type" => 1 );
	$projectEntitiesReverse[ "tr_finanzas_bancos_actualizar" ] = "tr_finanzas_bancos_actualizar";
	$projectEntities[ "tr_finanzas_tipo_de_cambio" ] = array( "url" => "tr_finanzas_tipo_de_cambio", "type" => 0 );
	$projectEntitiesReverse[ "tr_finanzas_tipo_de_cambio" ] = "tr_finanzas_tipo_de_cambio";
	$projectEntities[ "tr_compras_proveedores_02_cargos_abonos_centros_de_costos" ] = array( "url" => "tr_compras_proveedores_02_cargos_abonos_centros_de_costos", "type" => 0 );
	$projectEntitiesReverse[ "tr_compras_proveedores_02_cargos_abonos_centros_de_costos" ] = "tr_compras_proveedores_02_cargos_abonos_centros_de_costos";
	$projectEntities[ "tr_compras_proveedores_02_cargos_abonos_movimientos" ] = array( "url" => "tr_compras_proveedores_02_cargos_abonos_movimientos", "type" => 0 );
	$projectEntitiesReverse[ "tr_compras_proveedores_02_cargos_abonos_movimientos" ] = "tr_compras_proveedores_02_cargos_abonos_movimientos";
	$projectEntities[ "tr_compras_proveedores_01_cargos_abonos_update" ] = array( "url" => "tr_compras_proveedores_01_cargos_abonos_update", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_proveedores_01_cargos_abonos_update" ] = "tr_compras_proveedores_01_cargos_abonos_update";
	$projectEntities[ "tr_actividades_planeacion_app" ] = array( "url" => "tr_actividades_planeacion_app", "type" => 0 );
	$projectEntitiesReverse[ "tr_actividades_planeacion_app" ] = "tr_actividades_planeacion_app";
	$projectEntities[ "tr_actividades_planeacion_app_02" ] = array( "url" => "tr_actividades_planeacion_app_02", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_planeacion_app_02" ] = "tr_actividades_planeacion_app_02";
	$projectEntities[ "tr_actividades_planeacion_tareas_app" ] = array( "url" => "tr_actividades_planeacion_tareas_app", "type" => 0 );
	$projectEntitiesReverse[ "tr_actividades_planeacion_tareas_app" ] = "tr_actividades_planeacion_tareas_app";
	$projectEntities[ "box_root_cat_holding_03_empresas_unidades_productivas" ] = array( "url" => "box_root_cat_holding_03_empresas_unidades_productivas", "type" => 1 );
	$projectEntitiesReverse[ "box_root_cat_holding_03_empresas_unidades_productivas" ] = "box_root_cat_holding_03_empresas_unidades_productivas";
	$projectEntities[ "cat_holding_03_empresas_unidades_productivas_box" ] = array( "url" => "cat_holding_03_empresas_unidades_productivas_box", "type" => 1 );
	$projectEntitiesReverse[ "cat_holding_03_empresas_unidades_productivas_box" ] = "cat_holding_03_empresas_unidades_productivas_box";
	$projectEntities[ "cat_holding_04_unidades_productivas_lotes_box" ] = array( "url" => "cat_holding_04_unidades_productivas_lotes_box", "type" => 1 );
	$projectEntitiesReverse[ "cat_holding_04_unidades_productivas_lotes_box" ] = "cat_holding_04_unidades_productivas_lotes_box";
	$projectEntities[ "root_box_cat_holding_03_empresas_unidades_productivas" ] = array( "url" => "root_box_cat_holding_03_empresas_unidades_productivas", "type" => 1 );
	$projectEntitiesReverse[ "root_box_cat_holding_03_empresas_unidades_productivas" ] = "root_box_cat_holding_03_empresas_unidades_productivas";
	$projectEntities[ "root_box_cat_holding_04_unidades_productivas_lotes" ] = array( "url" => "root_box_cat_holding_04_unidades_productivas_lotes", "type" => 1 );
	$projectEntitiesReverse[ "root_box_cat_holding_04_unidades_productivas_lotes" ] = "root_box_cat_holding_04_unidades_productivas_lotes";
	$projectEntities[ "tr_compras_requisiciones_2" ] = array( "url" => "tr_compras_requisiciones_2", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_2" ] = "tr_compras_requisiciones_2";
	$projectEntities[ "tr_compras_requisiciones_02_productos_compras" ] = array( "url" => "tr_compras_requisiciones_02_productos_compras", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_02_productos_compras" ] = "tr_compras_requisiciones_02_productos_compras";
	$projectEntities[ "tr_compras_proveedores_01_cargos_abonos_pagos_revisar" ] = array( "url" => "tr_compras_proveedores_01_cargos_abonos_pagos_revisar", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_proveedores_01_cargos_abonos_pagos_revisar" ] = "tr_compras_proveedores_01_cargos_abonos_pagos_revisar";
	$projectEntities[ "tr_compras_facturas_sat_01" ] = array( "url" => "tr_compras_facturas_sat_01", "type" => 0 );
	$projectEntitiesReverse[ "tr_compras_facturas_sat_01" ] = "tr_compras_facturas_sat_01";
	$projectEntities[ "tr_compras_requisiciones_01_estatus" ] = array( "url" => "tr_compras_requisiciones_01_estatus", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_01_estatus" ] = "tr_compras_requisiciones_01_estatus";
	$projectEntities[ "tr_compras_requisiciones_02_productos_estatus" ] = array( "url" => "tr_compras_requisiciones_02_productos_estatus", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_requisiciones_02_productos_estatus" ] = "tr_compras_requisiciones_02_productos_estatus";
	$projectEntities[ "tr_compras_facturas_sat_02" ] = array( "url" => "tr_compras_facturas_sat_02", "type" => 0 );
	$projectEntitiesReverse[ "tr_compras_facturas_sat_02" ] = "tr_compras_facturas_sat_02";
	$projectEntities[ "tr_compras_proveedores_01_cargos_abonos_oc_pdf" ] = array( "url" => "tr_compras_proveedores_01_cargos_abonos_oc_pdf", "type" => 2 );
	$projectEntitiesReverse[ "tr_compras_proveedores_01_cargos_abonos_oc_pdf" ] = "tr_compras_proveedores_01_cargos_abonos_oc_pdf";
	$projectEntities[ "tr_compras_facturas_sat_01_estatus" ] = array( "url" => "tr_compras_facturas_sat_01_estatus", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_facturas_sat_01_estatus" ] = "tr_compras_facturas_sat_01_estatus";
	$projectEntities[ "tr_compras_proveedores_01_cargos_abonos_pagos_edit" ] = array( "url" => "tr_compras_proveedores_01_cargos_abonos_pagos_edit", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_proveedores_01_cargos_abonos_pagos_edit" ] = "tr_compras_proveedores_01_cargos_abonos_pagos_edit";
	$projectEntities[ "cat_finanzas_cuentas_de_balance_5" ] = array( "url" => "cat_finanzas_cuentas_de_balance_5", "type" => 1 );
	$projectEntitiesReverse[ "cat_finanzas_cuentas_de_balance_5" ] = "cat_finanzas_cuentas_de_balance_5";
	$projectEntities[ "box_cat_finanzas_cuentas_de_balance_5" ] = array( "url" => "box_cat_finanzas_cuentas_de_balance_5", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_finanzas_cuentas_de_balance_5" ] = "box_cat_finanzas_cuentas_de_balance_5";
	$projectEntities[ "box_tr_finanzas_bancos" ] = array( "url" => "box_tr_finanzas_bancos", "type" => 1 );
	$projectEntitiesReverse[ "box_tr_finanzas_bancos" ] = "box_tr_finanzas_bancos";
	$projectEntities[ "tr_tags" ] = array( "url" => "tr_tags", "type" => 0 );
	$projectEntitiesReverse[ "tr_tags" ] = "tr_tags";
	$projectEntities[ "tr_tags_regs" ] = array( "url" => "tr_tags_regs", "type" => 0 );
	$projectEntitiesReverse[ "tr_tags_regs" ] = "tr_tags_regs";
	$projectEntities[ "tr_tags_maestro" ] = array( "url" => "tr_tags_maestro", "type" => 1 );
	$projectEntitiesReverse[ "tr_tags_maestro" ] = "tr_tags_maestro";
	$projectEntities[ "box_cat_nominas_conceptos" ] = array( "url" => "box_cat_nominas_conceptos", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_nominas_conceptos" ] = "box_cat_nominas_conceptos";
	$projectEntities[ "tr_actividades_asistencias_app_horas_extras" ] = array( "url" => "tr_actividades_asistencias_app_horas_extras", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_asistencias_app_horas_extras" ] = "tr_actividades_asistencias_app_horas_extras";
	$projectEntities[ "cat_nominas_01_generales_llaves_st" ] = array( "url" => "cat_nominas_01_generales_llaves_st", "type" => 1 );
	$projectEntitiesReverse[ "cat_nominas_01_generales_llaves_st" ] = "cat_nominas_01_generales_llaves_st";
	$projectEntities[ "tr_control_de_riego_programas_ha_st" ] = array( "url" => "tr_control_de_riego_programas_ha_st", "type" => 1 );
	$projectEntitiesReverse[ "tr_control_de_riego_programas_ha_st" ] = "tr_control_de_riego_programas_ha_st";
	$projectEntities[ "tr_tags_edit" ] = array( "url" => "tr_tags_edit", "type" => 1 );
	$projectEntitiesReverse[ "tr_tags_edit" ] = "tr_tags_edit";
	$projectEntities[ "cat_trabajadores_estado_civil_mu" ] = array( "url" => "cat_trabajadores_estado_civil_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_trabajadores_estado_civil_mu" ] = "cat_trabajadores_estado_civil_mu";
	$projectEntities[ "cat_trabajadores_local_foraneo_mu" ] = array( "url" => "cat_trabajadores_local_foraneo_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_trabajadores_local_foraneo_mu" ] = "cat_trabajadores_local_foraneo_mu";
	$projectEntities[ "cat_trabajadores_sangre_mu" ] = array( "url" => "cat_trabajadores_sangre_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_trabajadores_sangre_mu" ] = "cat_trabajadores_sangre_mu";
	$projectEntities[ "cat_trabajadores_sexo_mu" ] = array( "url" => "cat_trabajadores_sexo_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_trabajadores_sexo_mu" ] = "cat_trabajadores_sexo_mu";
	$projectEntities[ "cat_trabajadores_tipo_de_pago" ] = array( "url" => "cat_trabajadores_tipo_de_pago", "type" => 0 );
	$projectEntitiesReverse[ "cat_trabajadores_tipo_de_pago" ] = "cat_trabajadores_tipo_de_pago";
	$projectEntities[ "tr_actividades_cosecha" ] = array( "url" => "tr_actividades_cosecha", "type" => 0 );
	$projectEntitiesReverse[ "tr_actividades_cosecha" ] = "tr_actividades_cosecha";
	$projectEntities[ "cat_produccion_cultivos_01_productos" ] = array( "url" => "cat_produccion_cultivos_01_productos", "type" => 0 );
	$projectEntitiesReverse[ "cat_produccion_cultivos_01_productos" ] = "cat_produccion_cultivos_01_productos";
	$projectEntities[ "tr_actividades_cosecha_consecutivo" ] = array( "url" => "tr_actividades_cosecha_consecutivo", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_cosecha_consecutivo" ] = "tr_actividades_cosecha_consecutivo";
	$projectEntities[ "cat_trabajadores_tabulador" ] = array( "url" => "cat_trabajadores_tabulador", "type" => 0 );
	$projectEntitiesReverse[ "cat_trabajadores_tabulador" ] = "cat_trabajadores_tabulador";
	$projectEntities[ "cat_holding_03_empresas_up_group_predios" ] = array( "url" => "cat_holding_03_empresas_up_group_predios", "type" => 0 );
	$projectEntitiesReverse[ "cat_holding_03_empresas_up_group_predios" ] = "cat_holding_03_empresas_up_group_predios";
	$projectEntities[ "cat_trabajadores_reingresos" ] = array( "url" => "cat_trabajadores_reingresos", "type" => 0 );
	$projectEntitiesReverse[ "cat_trabajadores_reingresos" ] = "cat_trabajadores_reingresos";
	$projectEntities[ "cat_trabajadores_alta_baja_mu" ] = array( "url" => "cat_trabajadores_alta_baja_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_trabajadores_alta_baja_mu" ] = "cat_trabajadores_alta_baja_mu";
	$projectEntities[ "cat_nominas_02_trabajadores" ] = array( "url" => "cat_nominas_02_trabajadores", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_02_trabajadores" ] = "cat_nominas_02_trabajadores";
	$projectEntities[ "box_cat_nominas_01_generales" ] = array( "url" => "box_cat_nominas_01_generales", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_nominas_01_generales" ] = "box_cat_nominas_01_generales";
	$projectEntities[ "tr_actividades_cosecha_detalle_tags" ] = array( "url" => "tr_actividades_cosecha_detalle_tags", "type" => 0 );
	$projectEntitiesReverse[ "tr_actividades_cosecha_detalle_tags" ] = "tr_actividades_cosecha_detalle_tags";
	$projectEntities[ "tr_actividades_cosecha_ranking_01" ] = array( "url" => "tr_actividades_cosecha_ranking_01", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_cosecha_ranking_01" ] = "tr_actividades_cosecha_ranking_01";
	$projectEntities[ "tr_actividades_asistencias_app_inf" ] = array( "url" => "tr_actividades_asistencias_app_inf", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_asistencias_app_inf" ] = "tr_actividades_asistencias_app_inf";
	$projectEntities[ "cat_nominas_02_horarios" ] = array( "url" => "cat_nominas_02_horarios", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_02_horarios" ] = "cat_nominas_02_horarios";
	$projectEntities[ "tr_actividades_asistencias_app_inf_inasistencias" ] = array( "url" => "tr_actividades_asistencias_app_inf_inasistencias", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_asistencias_app_inf_inasistencias" ] = "tr_actividades_asistencias_app_inf_inasistencias";
	$projectEntities[ "tr_actividades_cosecha_consecutivo_query" ] = array( "url" => "tr_actividades_cosecha_consecutivo_query", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_cosecha_consecutivo_query" ] = "tr_actividades_cosecha_consecutivo_query";
	$projectEntities[ "cat_trabajadores_puestos_historico" ] = array( "url" => "cat_trabajadores_puestos_historico", "type" => 0 );
	$projectEntitiesReverse[ "cat_trabajadores_puestos_historico" ] = "cat_trabajadores_puestos_historico";
	$projectEntities[ "tr_actividades_cosecha_consecutivo_detalle" ] = array( "url" => "tr_actividades_cosecha_consecutivo_detalle", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_cosecha_consecutivo_detalle" ] = "tr_actividades_cosecha_consecutivo_detalle";
	$projectEntities[ "cat_produccion_variedades" ] = array( "url" => "cat_produccion_variedades", "type" => 0 );
	$projectEntitiesReverse[ "cat_produccion_variedades" ] = "cat_produccion_variedades";
	$projectEntities[ "tr_actividades_asistencias_app_inf_horas_extras" ] = array( "url" => "tr_actividades_asistencias_app_inf_horas_extras", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_asistencias_app_inf_horas_extras" ] = "tr_actividades_asistencias_app_inf_horas_extras";
	$projectEntities[ "cat_trabajadores_altas_inf_destajo_cosecha" ] = array( "url" => "cat_trabajadores_altas_inf_destajo_cosecha", "type" => 1 );
	$projectEntitiesReverse[ "cat_trabajadores_altas_inf_destajo_cosecha" ] = "cat_trabajadores_altas_inf_destajo_cosecha";
	$projectEntities[ "tr_actividades_cosecha_query" ] = array( "url" => "tr_actividades_cosecha_query", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_cosecha_query" ] = "tr_actividades_cosecha_query";
	$projectEntities[ "tr_actividades_destajos" ] = array( "url" => "tr_actividades_destajos", "type" => 0 );
	$projectEntitiesReverse[ "tr_actividades_destajos" ] = "tr_actividades_destajos";
	$projectEntities[ "tr_actividades_asistencias_app_inf_horas_turno_vespertino" ] = array( "url" => "tr_actividades_asistencias_app_inf_horas_turno_vespertino", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_asistencias_app_inf_horas_turno_vespertino" ] = "tr_actividades_asistencias_app_inf_horas_turno_vespertino";
	$projectEntities[ "tr_actividades_asistencias_app_inf_horas_extras_sab_dom" ] = array( "url" => "tr_actividades_asistencias_app_inf_horas_extras_sab_dom", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_asistencias_app_inf_horas_extras_sab_dom" ] = "tr_actividades_asistencias_app_inf_horas_extras_sab_dom";
	$projectEntities[ "tr_actividades_asistencias_app_por_predio_query" ] = array( "url" => "tr_actividades_asistencias_app_por_predio_query", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_asistencias_app_por_predio_query" ] = "tr_actividades_asistencias_app_por_predio_query";
	$projectEntities[ "cat_trabajadores_altas1" ] = array( "url" => "cat_trabajadores_altas1", "type" => 1 );
	$projectEntitiesReverse[ "cat_trabajadores_altas1" ] = "cat_trabajadores_altas1";
	$projectEntities[ "cat_trabajadores_puestos_historico_query" ] = array( "url" => "cat_trabajadores_puestos_historico_query", "type" => 1 );
	$projectEntitiesReverse[ "cat_trabajadores_puestos_historico_query" ] = "cat_trabajadores_puestos_historico_query";
	$projectEntities[ "tr_actividades_cosecha1borrar" ] = array( "url" => "tr_actividades_cosecha1borrar", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_cosecha1borrar" ] = "tr_actividades_cosecha1borrar";
	$projectEntities[ "tr_compras_almacenes_01_recibo_lpn" ] = array( "url" => "tr_compras_almacenes_01_recibo_lpn", "type" => 0 );
	$projectEntitiesReverse[ "tr_compras_almacenes_01_recibo_lpn" ] = "tr_compras_almacenes_01_recibo_lpn";
	$projectEntities[ "tr_compras_almacenes_01_salida_lpn" ] = array( "url" => "tr_compras_almacenes_01_salida_lpn", "type" => 0 );
	$projectEntitiesReverse[ "tr_compras_almacenes_01_salida_lpn" ] = "tr_compras_almacenes_01_salida_lpn";
	$projectEntities[ "tr_compras_almacenes_02_salida_productos" ] = array( "url" => "tr_compras_almacenes_02_salida_productos", "type" => 0 );
	$projectEntitiesReverse[ "tr_compras_almacenes_02_salida_productos" ] = "tr_compras_almacenes_02_salida_productos";
	$projectEntities[ "cat_trabajadores_puestos_historico1borrar" ] = array( "url" => "cat_trabajadores_puestos_historico1borrar", "type" => 1 );
	$projectEntitiesReverse[ "cat_trabajadores_puestos_historico1borrar" ] = "cat_trabajadores_puestos_historico1borrar";
	$projectEntities[ "cat_compras_almacenes_tipo_de_salida_mu" ] = array( "url" => "cat_compras_almacenes_tipo_de_salida_mu", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_almacenes_tipo_de_salida_mu" ] = "cat_compras_almacenes_tipo_de_salida_mu";
	$projectEntities[ "tr_compras_almacenes_01_salida_lpn1borrar" ] = array( "url" => "tr_compras_almacenes_01_salida_lpn1borrar", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_almacenes_01_salida_lpn1borrar" ] = "tr_compras_almacenes_01_salida_lpn1borrar";
	$projectEntities[ "tr_compras_almacenes_02_salida_productos1borrar" ] = array( "url" => "tr_compras_almacenes_02_salida_productos1borrar", "type" => 1 );
	$projectEntitiesReverse[ "tr_compras_almacenes_02_salida_productos1borrar" ] = "tr_compras_almacenes_02_salida_productos1borrar";
	$projectEntities[ "cat_holding_04a_unidades_productivas_lotes_historico" ] = array( "url" => "cat_holding_04a_unidades_productivas_lotes_historico", "type" => 0 );
	$projectEntitiesReverse[ "cat_holding_04a_unidades_productivas_lotes_historico" ] = "cat_holding_04a_unidades_productivas_lotes_historico";
	$projectEntities[ "cat_holding_04_unidades_productivas_lotes_inf" ] = array( "url" => "cat_holding_04_unidades_productivas_lotes_inf", "type" => 1 );
	$projectEntitiesReverse[ "cat_holding_04_unidades_productivas_lotes_inf" ] = "cat_holding_04_unidades_productivas_lotes_inf";
	$projectEntities[ "tr_actividades_cosecha_query2borrar" ] = array( "url" => "tr_actividades_cosecha_query2borrar", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_cosecha_query2borrar" ] = "tr_actividades_cosecha_query2borrar";
	$projectEntities[ "tr_actividades_asistencias_app_horas_extras_borrar" ] = array( "url" => "tr_actividades_asistencias_app_horas_extras_borrar", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_asistencias_app_horas_extras_borrar" ] = "tr_actividades_asistencias_app_horas_extras_borrar";
	$projectEntities[ "cat_ventas_productos_variedades" ] = array( "url" => "cat_ventas_productos_variedades", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_productos_variedades" ] = "cat_ventas_productos_variedades";
	$projectEntities[ "cat_compras_productos_permitidos" ] = array( "url" => "cat_compras_productos_permitidos", "type" => 0 );
	$projectEntitiesReverse[ "cat_compras_productos_permitidos" ] = "cat_compras_productos_permitidos";
	$projectEntities[ "cat_compras_productos1" ] = array( "url" => "cat_compras_productos1", "type" => 1 );
	$projectEntitiesReverse[ "cat_compras_productos1" ] = "cat_compras_productos1";
	$projectEntities[ "tr_ventas_almacenes_01_up_salidas_lpn" ] = array( "url" => "tr_ventas_almacenes_01_up_salidas_lpn", "type" => 0 );
	$projectEntitiesReverse[ "tr_ventas_almacenes_01_up_salidas_lpn" ] = "tr_ventas_almacenes_01_up_salidas_lpn";
	$projectEntities[ "tr_ventas_almacenes_02_up_salidas_productos" ] = array( "url" => "tr_ventas_almacenes_02_up_salidas_productos", "type" => 0 );
	$projectEntitiesReverse[ "tr_ventas_almacenes_02_up_salidas_productos" ] = "tr_ventas_almacenes_02_up_salidas_productos";
	$projectEntities[ "box_cat_ventas_productos_variedades" ] = array( "url" => "box_cat_ventas_productos_variedades", "type" => 1 );
	$projectEntitiesReverse[ "box_cat_ventas_productos_variedades" ] = "box_cat_ventas_productos_variedades";
	$projectEntities[ "tr_actividades_cosecha_salidas_02" ] = array( "url" => "tr_actividades_cosecha_salidas_02", "type" => 0 );
	$projectEntitiesReverse[ "tr_actividades_cosecha_salidas_02" ] = "tr_actividades_cosecha_salidas_02";
	$projectEntities[ "cat_trabajadores_altas2" ] = array( "url" => "cat_trabajadores_altas2", "type" => 1 );
	$projectEntitiesReverse[ "cat_trabajadores_altas2" ] = "cat_trabajadores_altas2";
	$projectEntities[ "tr_actividades_cosecha_salidas_01 quey glori" ] = array( "url" => "tr_actividades_cosecha_salidas_01_quey_glori", "type" => 1 );
	$projectEntitiesReverse[ "tr_actividades_cosecha_salidas_01_quey_glori" ] = "tr_actividades_cosecha_salidas_01 quey glori";
	$projectEntities[ "tr_actividades_cosecha_salidas_01" ] = array( "url" => "tr_actividades_cosecha_salidas_01", "type" => 0 );
	$projectEntitiesReverse[ "tr_actividades_cosecha_salidas_01" ] = "tr_actividades_cosecha_salidas_01";
	$projectEntities[ "cat_ventas_productos_status_recibo" ] = array( "url" => "cat_ventas_productos_status_recibo", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_productos_status_recibo" ] = "cat_ventas_productos_status_recibo";
	$projectEntities[ "aux_puestos_horarios" ] = array( "url" => "aux_puestos_horarios", "type" => 0 );
	$projectEntitiesReverse[ "aux_puestos_horarios" ] = "aux_puestos_horarios";
	$projectEntities[ "aux_horarios" ] = array( "url" => "aux_horarios", "type" => 0 );
	$projectEntitiesReverse[ "aux_horarios" ] = "aux_horarios";
	$projectEntities[ "cat_nominas_feriados" ] = array( "url" => "cat_nominas_feriados", "type" => 0 );
	$projectEntitiesReverse[ "cat_nominas_feriados" ] = "cat_nominas_feriados";
	$projectEntities[ "aux_actividades_precios" ] = array( "url" => "aux_actividades_precios", "type" => 0 );
	$projectEntitiesReverse[ "aux_actividades_precios" ] = "aux_actividades_precios";
	$projectEntities[ "aux_dias_bonos" ] = array( "url" => "aux_dias_bonos", "type" => 0 );
	$projectEntitiesReverse[ "aux_dias_bonos" ] = "aux_dias_bonos";
	$projectEntities[ "aux_incidencias_justificables" ] = array( "url" => "aux_incidencias_justificables", "type" => 0 );
	$projectEntitiesReverse[ "aux_incidencias_justificables" ] = "aux_incidencias_justificables";
	$projectEntities[ "aux_nomina_justificantes_bonos" ] = array( "url" => "aux_nomina_justificantes_bonos", "type" => 0 );
	$projectEntitiesReverse[ "aux_nomina_justificantes_bonos" ] = "aux_nomina_justificantes_bonos";
	$projectEntities[ "puestos horarios" ] = array( "url" => "puestos_horarios", "type" => 6 );
	$projectEntitiesReverse[ "puestos_horarios" ] = "puestos horarios";
	$projectEntities[ "cat_produccion_proceso" ] = array( "url" => "cat_produccion_proceso", "type" => 0 );
	$projectEntitiesReverse[ "cat_produccion_proceso" ] = "cat_produccion_proceso";
	$projectEntities[ "tr_prenomina" ] = array( "url" => "tr_prenomina", "type" => 6 );
	$projectEntitiesReverse[ "tr_prenomina" ] = "tr_prenomina";
	$projectEntities[ "cat_ventas_productos_precios" ] = array( "url" => "cat_ventas_productos_precios", "type" => 0 );
	$projectEntitiesReverse[ "cat_ventas_productos_precios" ] = "cat_ventas_productos_precios";
}
