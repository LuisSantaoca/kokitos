...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("cat_trabajadores_altas" == $this->chrt_array['tables'][0])
			return true;
		if("aaa_permisos_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("aaa_permisos_ugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("cat_usuarios_licencias" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades" == $this->chrt_array['tables'][0])
			return true;
		if("cat_usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("cat_usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades_categorias" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_documentos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_puestos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_puestos_areas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_puestos_categorias" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_altas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_altas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades_unidades_de_costo" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_documentos_link" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_requisiciones_01" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_productos_categorias" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_proveedores" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_01" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_02_empresas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_03_empresas_registros_patronales" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_proveedores_categorias" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_requisiciones_02_productos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_documentos_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_estatus_mu" == $this->chrt_array['tables'][0])
			return true;
		if("tr_root_audit_editing_locking" == $this->chrt_array['tables'][0])
			return true;
		if("tr_root_audit_log_audit" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_productos_unidad_de_medida_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_productos_presentacion_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_estatus_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_usuarios" == $this->chrt_array['tables'][0])
		...
		if("tr_compras_requisiciones_02_productos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_03_empresas_departamentos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_almacenes" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades_categorias_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_almacenes" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_categorias" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_sku" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_presentaciones" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_manejo" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_unidades_de_medida" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_unidades_de_produccion" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_marcas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_almacenes_categorias" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_clientes" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_movimientos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_centros_de_costos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_altas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades" == $this->chrt_array['tables'][0])
			return true;
		if("cat_usuarios_02_modulos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_usuarios_modulos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_unidades_de_venta" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_almacenes" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_sku" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_03_empresas_almacenes" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_03_empresas_unidades_productivas" == $this->chrt_array['tables'][0])
			return true;
		if("tr_finanzas_bancos_01" == $this->chrt_array['tables'][0])
			return true;
		if("tr_finanzas_bancos_02" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_bancos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_bancos_cuentas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_bancos_cuentas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_03_empresas_unidades_productivas_categorias" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_03_empresas_mu_unidades_productivas_categorias" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_04_unidades_productivas_lotes" == $this->chrt_array['tables'][0])
			return true;
		if("cat_usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_04_unidades_productivas_lotes_categorias" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_04_unidades_productivas_mu_lotes_categorias" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_requisiciones_01" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_requisiciones_02_productos" == $this->chrt_array['tables'][0])
		...
		if("cat_finanzas_movimientos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_productos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_requisiciones_01" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_socios" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_03_empresas_unidades_productivas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_productos" == $this->chrt_array['tables'][0])
		...
		if("cat_actividades_unidades_de_costo" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_lotes" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_centros_de_costos_categorias_mu" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_requisiciones_01" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_almacenes" == $this->chrt_array['tables'][0])
		...
		if("tr_compras_requisiciones_01" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_cuentas_de_balance_04" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_cuentas_de_balance_04" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_cuentas_de_balance_01_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_cuentas_de_balance_02_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_cuentas_de_balance_03_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades_turnos_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_04_unidades_productivas_lotes" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_aplicaciones_campo_boquillas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_aplicaciones_campo_metodo_de_aplicacion" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_aplicaciones_campo_tipo_de_control" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_clientes" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_sku" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_facturas_sat_01" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_tipo_de_pago_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_transacciones_categorias_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_cuentas_de_balance_04" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_almacenes_estatus_mu" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_requisiciones_02_productos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_04_unidades_productivas_lotes" == $this->chrt_array['tables'][0])
		...
		if("cat_trabajadores_altas" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_almacenes_inventario_02_productos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_almacenes_inventario_03" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_dias_semana_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_periodicidad_mu" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_requisiciones_01" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_requisiciones_01" == $this->chrt_array['tables'][0])
		...
		if("tr_compras_requisiciones_02_productos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_finanzas_movimientos_balance" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_cuentas_de_balance_03_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_movimientos_categorias_naturaleza_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_movimientos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_monedas_mu" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_requisiciones_01" == $this->chrt_array['tables'][0])
			return true;
		if("cat_root_tablas_de_catalogos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades_variables_de_ejecucion" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_conceptos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_conceptos_clasificacion_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_02_actividades" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades_alcance_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_conceptos_factor_de_calculo_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_intervalos_mu" == $this->chrt_array['tables'][0])
			return true;
		if("tr_finanzas_bancos_02" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_bancos_cuentas" == $this->chrt_array['tables'][0])
		...
		if("cat_finanzas_centros_de_costos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_cajas_chicas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_cajas_chicas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_productos_unidad_de_costo_mu" == $this->chrt_array['tables'][0])
			return true;
		if("tr_finanzas_bancos_01" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_aplicaciones_campo_productos_funcionalidad" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_plagas_y_enfermedades" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_plagas_y_enfermedades" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_plagas_y_enfermedades_categorias" == $this->chrt_array['tables'][0])
			return true;
		if("tr_control_de_plagas_app" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_productos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_almacenes_productos_estatus_catalogo_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_almacenes_tipo_de_recibo_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_almacenes_tipo_de_recibo_mu" == $this->chrt_array['tables'][0])
			return true;
		if("tr_control_aplicaciones_campo_planeacion_recetas_app" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_configuracion_global" == $this->chrt_array['tables'][0])
			return true;
		if("cat_produccion_temporadas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_aplicaciones_alcance_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_aplicaciones_alcance_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_aplicaciones_recetas_02_productos_app" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_aplicaciones_recetas_cts_01_nombre" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_aplicaciones_recetas_cts_01_nombre" == $this->chrt_array['tables'][0])
			return true;
		if("tr_control_aplicaciones_campo_02_up_productos_app" == $this->chrt_array['tables'][0])
			return true;
		if("tr_control_aplicaciones_campo_03_lotes_app" == $this->chrt_array['tables'][0])
			return true;
		if("tr_control_aplicaciones_campo_04_trabajadores_app" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_almacenes_02_recibo_productos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_aplicaciones_recetas_cts_01_nombre" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_requisiciones_02_productos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_facturas_sat_02_carga_masiva" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_incidencias_mu" == $this->chrt_array['tables'][0])
			return true;
		if("tr_finanzas_bancos_02_uuid_sat" == $this->chrt_array['tables'][0])
			return true;
		if("tr_finanzas_aportaciones_socios_01" == $this->chrt_array['tables'][0])
			return true;
		if("tr_menu_noticias" == $this->chrt_array['tables'][0])
			return true;
		if("tr_menu_sugerencias" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_asistencias_app" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_01_generales" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_03_trabajadores_costo_bruto_conceptos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades_especificas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades_metodo_de_costeo_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades_forma_de_pago_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades_especificas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_variables_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_condicionantes_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_root_operadores" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_prestaciones_especiales" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_prestaciones_especiales_forma_de_pago_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades_turnos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_uuid_semana" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_prestamos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_prestaciones_individuales" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_incidencias" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_uuid_semana" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades_ingreso_egreso_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_actividades_turnos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_asistencias_app" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_dias_de_inicio_consecutivos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_asistencias_fechas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_asistencias_fechas_uuid_semana" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_movimientos_categoria" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_movimientos_categoria_sub" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_movimientos_categoria" == $this->chrt_array['tables'][0])
			return true;
		if("cat_finanzas_movimientos_categoria_sub" == $this->chrt_array['tables'][0])
		...
		if("cat_nominas_02_actividades" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_riego_cabezales" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_riego_cabezales_pulsos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_control_de_riego_pulsos_01" == $this->chrt_array['tables'][0])
			return true;
		if("tr_control_de_riego_pulsos_02_lotes" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_riego_cabezales" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_riego_cabezales_pulsos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_finanzas_bancos_02_movimientos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_culturales_01" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_culturales_02" == $this->chrt_array['tables'][0])
			return true;
		if("tr_control_aplicaciones_03_trabajadores_sectores" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_productos_unidad_de_medida_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_aplicaciones_campo_tipo_de_control" == $this->chrt_array['tables'][0])
			return true;
		if("cat_control_aplicaciones_contenedores_mezcladores_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_productos_precios" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_proveedores_sat" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_proveedores_01_cargos_abonos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_cargo_abono_mu" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_proveedores_01_cargos_abonos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_proveedores_01_cargos_abonos" == $this->chrt_array['tables'][0])
		...
		if("tr_finanzas_bancos_01" == $this->chrt_array['tables'][0])
			return true;
		if("tr_finanzas_tipo_de_cambio" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_proveedores_02_cargos_abonos_centros_de_costos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_proveedores_02_cargos_abonos_movimientos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_proveedores_01_cargos_abonos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_planeacion_app" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_planeacion_app" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_planeacion_tareas_app" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_03_empresas_unidades_productivas" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_03_empresas_unidades_productivas" == $this->chrt_array['tables'][0])
		...
		if("tr_compras_requisiciones_02_productos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_facturas_sat_02" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_proveedores_01_cargos_abonos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_facturas_sat_01" == $this->chrt_array['tables'][0])
		...
		if("tr_finanzas_bancos_01" == $this->chrt_array['tables'][0])
			return true;
		if("tr_tags" == $this->chrt_array['tables'][0])
			return true;
		if("tr_tags_regs" == $this->chrt_array['tables'][0])
			return true;
		if("tr_tags" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_conceptos" == $this->chrt_array['tables'][0])
		...
		if("tr_tags" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_estado_civil_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_local_foraneo_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_sangre_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_sexo_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_tipo_de_pago" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_cosecha" == $this->chrt_array['tables'][0])
			return true;
		if("cat_produccion_cultivos_01_productos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_cosecha" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_tabulador" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_03_empresas_up_group_predios" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_reingresos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_alta_baja_mu" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_02_trabajadores" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_01_generales" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_cosecha_detalle_tags" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_cosecha" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_asistencias_app" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_02_horarios" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_asistencias_app" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_cosecha" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_puestos_historico" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_cosecha" == $this->chrt_array['tables'][0])
			return true;
		if("cat_produccion_variedades" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_asistencias_app" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_altas" == $this->chrt_array['tables'][0])
		...
		if("tr_actividades_cosecha" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_destajos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_asistencias_app" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_asistencias_app" == $this->chrt_array['tables'][0])
		...
		if("tr_actividades_cosecha" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_almacenes_01_recibo_lpn" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_almacenes_01_salida_lpn" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_almacenes_02_salida_productos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_puestos_historico" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_almacenes_tipo_de_salida_mu" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_almacenes_01_salida_lpn" == $this->chrt_array['tables'][0])
			return true;
		if("tr_compras_almacenes_02_salida_productos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_04a_unidades_productivas_lotes_historico" == $this->chrt_array['tables'][0])
			return true;
		if("cat_holding_04_unidades_productivas_lotes" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_cosecha" == $this->chrt_array['tables'][0])
		...
		if("tr_actividades_asistencias_app" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_variedades" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_productos_permitidos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_compras_productos" == $this->chrt_array['tables'][0])
			return true;
		if("tr_ventas_almacenes_01_up_salidas_lpn" == $this->chrt_array['tables'][0])
			return true;
		if("tr_ventas_almacenes_02_up_salidas_productos" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_variedades" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_cosecha_salidas_02" == $this->chrt_array['tables'][0])
			return true;
		if("cat_trabajadores_altas" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_cosecha_salidas_01" == $this->chrt_array['tables'][0])
			return true;
		if("tr_actividades_cosecha_salidas_01" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_status_recibo" == $this->chrt_array['tables'][0])
			return true;
		if("aux_puestos_horarios" == $this->chrt_array['tables'][0])
			return true;
		if("aux_horarios" == $this->chrt_array['tables'][0])
			return true;
		if("cat_nominas_feriados" == $this->chrt_array['tables'][0])
			return true;
		if("aux_actividades_precios" == $this->chrt_array['tables'][0])
			return true;
		if("aux_dias_bonos" == $this->chrt_array['tables'][0])
			return true;
		if("aux_incidencias_justificables" == $this->chrt_array['tables'][0])
			return true;
		if("aux_nomina_justificantes_bonos" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("cat_produccion_proceso" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("cat_ventas_productos_precios" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
