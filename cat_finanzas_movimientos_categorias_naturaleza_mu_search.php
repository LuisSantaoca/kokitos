...
require_once("include/cat_finanzas_movimientos_categorias_naturaleza_mu_variables.php");
...
$params['shortTableName'] = 'cat_finanzas_movimientos_categorias_naturaleza_mu';
