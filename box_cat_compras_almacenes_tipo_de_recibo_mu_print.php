...
require_once("include/box_cat_compras_almacenes_tipo_de_recibo_mu_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "box_cat_compras_almacenes_tipo_de_recibo_mu" );
