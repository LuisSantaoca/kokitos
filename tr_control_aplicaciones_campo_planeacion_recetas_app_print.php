...
require_once("include/tr_control_aplicaciones_campo_planeacion_recetas_app_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tr_control_aplicaciones_campo_planeacion_recetas_app" );
